...
public class BRERuleEngineEventsAPI: APIBase {
     ...
     */
    public class func sendBREEvent(breEvent breEvent: BreEvent? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func sendBREEventWithRequestBuilder(breEvent breEvent: BreEvent? = nil) -> RequestBuilder<Void> {
        let path = "/bre/events"
