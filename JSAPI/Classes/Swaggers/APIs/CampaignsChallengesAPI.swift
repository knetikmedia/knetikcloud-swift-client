...
public class CampaignsChallengesAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getChallenges(filterTemplate filterTemplate: Bool? = nil, filterActiveCampaign: Bool? = nil, filterStartDate: String? = nil, filterEndDate: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceChallengeResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getChallengesWithRequestBuilder(filterTemplate filterTemplate: Bool? = nil, filterActiveCampaign: Bool? = nil, filterStartDate: String? = nil, filterEndDate: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceChallengeResource> {
        let path = "/challenges"
        let URLString = JSAPIAPI.basePath + path
