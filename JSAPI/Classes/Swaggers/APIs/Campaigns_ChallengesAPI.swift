...
public class Campaigns_ChallengesAPI: APIBase {
    /**
     Create a challenge
  ...
  "start_date" : 2
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateChallengeActivity(id id: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil, validateSettings: Bool? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateChallengeActivityWithRequestBuilder(id id: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil, validateSettings: Bool? = nil) -> RequestBuilder<Void> {
        var path = "/challenges/{challengeId}/activities/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{challenge_id}", withString: "\(challengeId)", options: .LiteralSearch, range: nil)
        let URLString = JSAPIAPI.basePath + path
