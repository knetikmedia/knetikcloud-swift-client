...
public class ContentCommentsAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func searchComments(query query: AnyObject? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceCommentResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceCommentResource> 
     */
    public class func searchCommentsWithRequestBuilder(query query: AnyObject? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceCommentResource> {
