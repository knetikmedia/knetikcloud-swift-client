...
public class Gamification_AchievementsAPI: APIBase {
    /**
  ...
  "trigger_description" : "trigger_description"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getAchievements(filterTagset filterTagset: String? = nil, filterName: String? = nil, filterHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, filterDerived: Bool? = nil, completion: ((data: PageResourceAchievementDefinitionResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getAchievementsWithRequestBuilder(filterTagset filterTagset: String? = nil, filterName: String? = nil, filterHidden: Bool? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, filterDerived: Bool? = nil) -> RequestBuilder<PageResourceAchievementDefinitionResource> {
        let path = "/achievements"
        let URLString = JSAPIAPI.basePath + path
