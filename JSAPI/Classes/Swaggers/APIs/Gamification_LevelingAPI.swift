...
public class Gamification_LevelingAPI: APIBase {
    /**
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserLevel(userId userId: String, name: String, completion: ((data: UserLevelingResource?, error: ErrorType?) -> Void)) {
  ...
  "next_tier_progress" : 6
     ...
     */
    public class func getUserLevelWithRequestBuilder(userId userId: String, name: String) -> RequestBuilder<UserLevelingResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserLevels(userId userId: String, filterName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceUserLevelingResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getUserLevelsWithRequestBuilder(userId userId: String, filterName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceUserLevelingResource> {
