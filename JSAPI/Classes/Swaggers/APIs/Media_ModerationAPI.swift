...
public class Media_ModerationAPI: APIBase {
    /**
     Add a flag
  ...
  "resolved" : 1
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getModerationReports(excludeResolved excludeResolved: Bool? = nil, filterContext: String? = nil, filterContextId: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceFlagReportResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getModerationReportsWithRequestBuilder(excludeResolved excludeResolved: Bool? = nil, filterContext: String? = nil, filterContextId: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceFlagReportResource> {
