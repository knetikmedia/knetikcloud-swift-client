...
public class Payments_AppleAPI: APIBase {
    /**
     ...
     */
    public class func verifyAppleReceipt(request request: ApplyPaymentRequest? = nil, completion: ((data: String?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func verifyAppleReceiptWithRequestBuilder(request request: ApplyPaymentRequest? = nil) -> RequestBuilder<String> {
