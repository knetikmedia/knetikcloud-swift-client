...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 7.429409248344544,
  "sale_count" : 2,
  "sales_total" : 7.628602779093151,
  "customer_count" : 8
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 0.19654962609789162,
  "sale_count" : 2,
  "sales_total" : 4.697260551165645,
  "customer_count" : 1
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.1103914357049947,
  "sale_count" : 6,
  "sales_total" : 3.6351285059308838,
  "customer_count" : 4
}}]
