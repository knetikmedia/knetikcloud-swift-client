...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 1.4419706487865436,
  "sale_count" : 4,
  "sales_total" : 1.4831577343602431,
  "customer_count" : 3
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.953384157248116,
  "sale_count" : 5,
  "sales_total" : 5.768330610959164,
  "customer_count" : 9
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.367681141786764,
  "sale_count" : 0,
  "sales_total" : 7.877261631216278,
  "customer_count" : 5
}}]
