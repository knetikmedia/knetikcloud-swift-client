...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 8.488855026505242,
  "sale_count" : 0,
  "sales_total" : 6.352529769255816,
  "customer_count" : 9
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 1.8323673861323997,
  "sale_count" : 9,
  "sales_total" : 8.2193087125864,
  "customer_count" : 5
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.950284145030491,
  "sale_count" : 8,
  "sales_total" : 3.9806087686575706,
  "customer_count" : 2
}}]
