...
public class StoreAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func quickBuy(quickBuyRequest quickBuyRequest: QuickBuyRequest? = nil, completion: ((data: InvoiceResource?, error: ErrorType?) -> Void)) {
  ...
  "shipping_postal_code" : "shipping_postal_code"
     ...
     */
    public class func quickBuyWithRequestBuilder(quickBuyRequest quickBuyRequest: QuickBuyRequest? = nil) -> RequestBuilder<InvoiceResource> {
