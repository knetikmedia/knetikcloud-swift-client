...
public class StoreAPI: APIBase {
     ...
     */
    public class func createItemTemplate(itemTemplateResource itemTemplateResource: StoreItemTemplateResource? = nil, completion: ((data: StoreItemTemplateResource?, error: ErrorType?) -> Void)) {
  ...
  "properties" : [ {
     ...
     */
    public class func createItemTemplateWithRequestBuilder(itemTemplateResource itemTemplateResource: StoreItemTemplateResource? = nil) -> RequestBuilder<StoreItemTemplateResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func createStoreItem(cascade cascade: Bool? = nil, storeItem: StoreItem? = nil, completion: ((data: StoreItem?, error: ErrorType?) -> Void)) {
  ...
  "skus" : [ {
    "sale_id" : 4,
    "original_price" : 3.4040570335626965,
    "description" : "aeiou",
    "stop_date" : 5,
    "published" : false,
    "inventory" : 9,
  ...
  "category" : "aeiou"
     ...
     */
    public class func createStoreItemWithRequestBuilder(cascade cascade: Bool? = nil, storeItem: StoreItem? = nil) -> RequestBuilder<StoreItem> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteItemTemplate(id id: String, cascade: String? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func deleteItemTemplateWithRequestBuilder(id id: String, cascade: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteStoreItem(id id: Int32, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteStoreItemWithRequestBuilder(id id: Int32) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getBehaviors(completion: ((data: [BehaviorDefinitionResource]?, error: ErrorType?) -> Void)) {
  ...
  "properties" : [ {
     ...
     */
    public class func getBehaviorsWithRequestBuilder() -> RequestBuilder<[BehaviorDefinitionResource]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemTemplate(id id: String, completion: ((data: StoreItemTemplateResource?, error: ErrorType?) -> Void)) {
  ...
  "properties" : [ {
    ...
    "required" : false
     ...
     - returns: RequestBuilder<StoreItemTemplateResource> 
     */
    public class func getItemTemplateWithRequestBuilder(id id: String) -> RequestBuilder<StoreItemTemplateResource> {
        var path = "/store/items/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = JSAPIAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemTemplates(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceStoreItemTemplateResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getItemTemplatesWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceStoreItemTemplateResource> {
        let path = "/store/items/templates"
        let URLString = JSAPIAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getStore(limit limit: Int32? = nil, page: Int32? = nil, useCatalog: Bool? = nil, ignoreLocation: Bool? = nil, inStockOnly: Bool? = nil, completion: ((data: PageResourceStoreItem?, error: ErrorType?) -> Void)) {
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 7,
      "original_price" : 5.346562506656619,
      "description" : "aeiou",
      "stop_date" : 4,
      "published" : false,
      "inventory" : 7,
  ...
  "first" : true
     ...
     */
    public class func getStoreWithRequestBuilder(limit limit: Int32? = nil, page: Int32? = nil, useCatalog: Bool? = nil, ignoreLocation: Bool? = nil, inStockOnly: Bool? = nil) -> RequestBuilder<PageResourceStoreItem> {
        let path = "/store"
        let URLString = JSAPIAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getStoreItem(id id: Int32, completion: ((data: StoreItem?, error: ErrorType?) -> Void)) {
  ...
  "skus" : [ {
    "sale_id" : 3,
    "original_price" : 0.33359782063093646,
    "description" : "aeiou",
    "stop_date" : 7,
    "published" : false,
    "inventory" : 0,
  ...
  "category" : "aeiou"
     ...
     - returns: RequestBuilder<StoreItem> 
     */
    public class func getStoreItemWithRequestBuilder(id id: Int32) -> RequestBuilder<StoreItem> {
        var path = "/store/items/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = JSAPIAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getStoreItems(filterNameSearch filterNameSearch: String? = nil, filterUniqueKey: String? = nil, filterPublished: Bool? = nil, filterDisplayable: Bool? = nil, filterStart: String? = nil, filterEnd: String? = nil, filterStartDate: String? = nil, filterStopDate: String? = nil, filterSku: String? = nil, filterPrice: String? = nil, filterTag: String? = nil, filterItemsByType: String? = nil, filterBundledSkus: String? = nil, filterVendor: Int32? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceStoreItem?, error: ErrorType?) -> Void)) {
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 0,
      "original_price" : 0.3016951574990745,
      "description" : "aeiou",
      "stop_date" : 1,
      "published" : false,
      "inventory" : 7,
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateItemTemplate(id id: String, itemTemplateResource: StoreItemTemplateResource? = nil, completion: ((data: StoreItemTemplateResource?, error: ErrorType?) -> Void)) {
  ...
  "properties" : [ {
    ...
    "required" : false
     ...
     - returns: RequestBuilder<StoreItemTemplateResource> 
     */
    public class func updateItemTemplateWithRequestBuilder(id id: String, itemTemplateResource: StoreItemTemplateResource? = nil) -> RequestBuilder<StoreItemTemplateResource> {
        var path = "/store/items/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = JSAPIAPI.basePath + path
        let parameters = itemTemplateResource?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateStoreItem(id id: Int32, cascade: Bool? = nil, storeItem: StoreItem? = nil, completion: ((data: StoreItem?, error: ErrorType?) -> Void)) {
  ...
  "skus" : [ {
    "sale_id" : 8,
    "original_price" : 9.61128580718024,
    "description" : "aeiou",
    "stop_date" : 0,
    "published" : false,
    "inventory" : 4,
  ...
  "category" : "aeiou"
     ...
     - returns: RequestBuilder<StoreItem> 
     */
    public class func updateStoreItemWithRequestBuilder(id id: Int32, cascade: Bool? = nil, storeItem: StoreItem? = nil) -> RequestBuilder<StoreItem> {
        var path = "/store/items/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = JSAPIAPI.basePath + path
        let parameters = storeItem?.encodeToJSON() as? [String:AnyObject]
