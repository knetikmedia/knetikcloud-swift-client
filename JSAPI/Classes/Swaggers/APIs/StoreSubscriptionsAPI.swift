...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 8.552249932050852,
    "late_payment_fee" : 1.7705366421799873,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 2.49855071198131,
    "min_cycles" : 1,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    ...
    "reactivation_fee" : 3.203590769043021,
    "max_cycles" : 2
  } ],
  "store_start" : 8,
  "vendor_id" : 2,
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 5.520397440475962,
    "late_payment_fee" : 6.420468502614107,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 9.58724252986315,
    "min_cycles" : 2,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 2.7478387020926998,
    "max_cycles" : 2
  } ],
  "store_start" : 8,
  "vendor_id" : 9,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 6.99666700351571,
      "late_payment_fee" : 4.163889833305104,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 7.041165774491574,
      "min_cycles" : 2,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 4,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 1.9859139045196716,
      "max_cycles" : 8
    } ],
    "store_start" : 7,
    "vendor_id" : 3,
