...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 9.0043483980099,
    "late_payment_fee" : 3.588207652733569,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 0.09422688208340246,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 0,
    ...
    "reactivation_fee" : 4.9157528131745565,
    "max_cycles" : 3
  } ],
  "store_start" : 0,
  "vendor_id" : 8,
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 7.032321302765828,
    "late_payment_fee" : 9.453259322943591,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.27690140945594,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 6.312943051504013,
    "max_cycles" : 5
  } ],
  "store_start" : 9,
  "vendor_id" : 4,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 2.2481951759165653,
      "late_payment_fee" : 6.984360440600415,
      "billing_cycle_length" : 1,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 4.55646370594841,
      "min_cycles" : 8,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 0,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 9.607342234592114,
      "max_cycles" : 5
    } ],
    "store_start" : 4,
    "vendor_id" : 2,
