...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 9.319975699269841,
    "late_payment_fee" : 2.267045506829094,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 0.167072347440822,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    ...
    "reactivation_fee" : 9.744142281512255,
    "max_cycles" : 9
  } ],
  "store_start" : 0,
  "vendor_id" : 0,
  ...
  "plans" : [ {
    "end_date" : 7,
    "initial_fee" : 2.7216076459715497,
    "late_payment_fee" : 2.279403878262066,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.3776502794624763,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 7.050660195251722,
    "max_cycles" : 6
  } ],
  "store_start" : 8,
  "vendor_id" : 9,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 2,
      "initial_fee" : 7.815462217659885,
      "late_payment_fee" : 9.055511117166319,
      "billing_cycle_length" : 6,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 4.642551479605866,
      "min_cycles" : 5,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 2,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 5.421283232104949,
      "max_cycles" : 3
    } ],
    "store_start" : 0,
    "vendor_id" : 4,
