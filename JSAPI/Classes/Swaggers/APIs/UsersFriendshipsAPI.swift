...
public class UsersFriendshipsAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getFriends(userId userId: String, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceSimpleUserResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getFriendsWithRequestBuilder(userId userId: String, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceSimpleUserResource> {
