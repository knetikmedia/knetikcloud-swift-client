...
class Decoders {
    ...
    static private func initialize() {
        dispatch_once(&once) {
            ...
            Decoders.addDecoder(clazz: [ActionContextobject].self) { (source: AnyObject) -> [ActionContextobject] in
                return Decoders.decode(clazz: [ActionContextobject].self, source: source)
            }
            // Decoder for ActionContextobject
            Decoders.addDecoder(clazz: ActionContextobject.self) { (source: AnyObject) -> ActionContextobject in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ActionContextobject()
                instance.mapping = Decoders.decodeOptional(clazz: AnyObject.self, source: sourceDictionary["mapping"])
            ...
            Decoders.addDecoder(clazz: [ActivityOccurrenceResultsResource].self) { (source: AnyObject) -> [ActivityOccurrenceResultsResource] in
                return Decoders.decode(clazz: [ActivityOccurrenceResultsResource].self, source: source)
            }
            // Decoder for ActivityOccurrenceResultsResource
            Decoders.addDecoder(clazz: ActivityOccurrenceResultsResource.self) { (source: AnyObject) -> ActivityOccurrenceResultsResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ActivityOccurrenceResultsResource()
                instance.users = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["users"])
                return instance
            }
            ...
            // Decoder for [ActivityOccurrenceStatusWrapper]
            Decoders.addDecoder(clazz: [ActivityOccurrenceStatusWrapper].self) { (source: AnyObject) -> [ActivityOccurrenceStatusWrapper] in
                return Decoders.decode(clazz: [ActivityOccurrenceStatusWrapper].self, source: source)
            }
            // Decoder for ActivityOccurrenceStatusWrapper
            Decoders.addDecoder(clazz: ActivityOccurrenceStatusWrapper.self) { (source: AnyObject) -> ActivityOccurrenceStatusWrapper in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ActivityOccurrenceStatusWrapper()
                instance.value = ActivityOccurrenceStatusWrapper.Value(rawValue: (sourceDictionary["value"] as? String) ?? "") 
                return instance
            }
            ...
            Decoders.addDecoder(clazz: ActivityResource.self) { (source: AnyObject) -> ActivityResource in
                ...
                instance.templateId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["template_id"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
            ...
            // Decoder for [ActivityUserStatusWrapper]
            Decoders.addDecoder(clazz: [ActivityUserStatusWrapper].self) { (source: AnyObject) -> [ActivityUserStatusWrapper] in
                return Decoders.decode(clazz: [ActivityUserStatusWrapper].self, source: source)
            }
            // Decoder for ActivityUserStatusWrapper
            Decoders.addDecoder(clazz: ActivityUserStatusWrapper.self) { (source: AnyObject) -> ActivityUserStatusWrapper in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ActivityUserStatusWrapper()
                instance.value = ActivityUserStatusWrapper.Value(rawValue: (sourceDictionary["value"] as? String) ?? "") 
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [ArgumentResource].self) { (source: AnyObject) -> [ArgumentResource] in
                return Decoders.decode(clazz: [ArgumentResource].self, source: source)
            }
            // Decoder for ArgumentResource
            Decoders.addDecoder(clazz: ArgumentResource.self) { (source: AnyObject) -> ArgumentResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ArgumentResource()
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                return instance
            }
            ...
            // Decoder for [BasicTemplatedResource]
            Decoders.addDecoder(clazz: [BasicTemplatedResource].self) { (source: AnyObject) -> [BasicTemplatedResource] in
                return Decoders.decode(clazz: [BasicTemplatedResource].self, source: source)
            }
            // Decoder for BasicTemplatedResource
            Decoders.addDecoder(clazz: BasicTemplatedResource.self) { (source: AnyObject) -> BasicTemplatedResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = BasicTemplatedResource()
                instance.additionalProperties = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["additional_properties"])
                instance.template = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["template"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: BatchResult.self) { (source: AnyObject) -> BatchResult in
                ...
                instance.batchReturn = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["batch_return"])
                instance.createdDate = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["created_date"])
                instance.id = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["id"])
                instance.updatedDate = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["updated_date"])
                return instance
            ...
            Decoders.addDecoder(clazz: BehaviorDefinitionResource.self) { (source: AnyObject) -> BehaviorDefinitionResource in
                ...
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.prerequisiteBehaviors = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["prerequisite_behaviors"])
            ...
            Decoders.addDecoder(clazz: BreEventLog.self) { (source: AnyObject) -> BreEventLog in
                ...
                instance.eventId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["event_id"])
                instance.eventName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["event_name"])
            ...
            Decoders.addDecoder(clazz: BreRule.self) { (source: AnyObject) -> BreRule in
                ...
                instance.condition = Decoders.decodeOptional(clazz: PredicateResource.self, source: sourceDictionary["condition"])
            ...
            Decoders.addDecoder(clazz: Cart.self) { (source: AnyObject) -> Cart in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = Cart()
                instance.availableShippingOptions = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["available_shipping_options"])
            ...
            Decoders.addDecoder(clazz: ConfigLookupResource.self) { (source: AnyObject) -> ConfigLookupResource in
                ...
                instance.lookupKey = Decoders.decodeOptional(clazz: ExpressionResource.self, source: sourceDictionary["lookup_key"])
            ...
            Decoders.addDecoder(clazz: [CreateActivityOccurrenceRequest].self) { (source: AnyObject) -> [CreateActivityOccurrenceRequest] in
                return Decoders.decode(clazz: [CreateActivityOccurrenceRequest].self, source: source)
            }
            // Decoder for CreateActivityOccurrenceRequest
            Decoders.addDecoder(clazz: CreateActivityOccurrenceRequest.self) { (source: AnyObject) -> CreateActivityOccurrenceRequest in
                let sourceDictionary = source as! [NSObject:AnyObject]
            ...
            Decoders.addDecoder(clazz: DateOperationResource.self) { (source: AnyObject) -> DateOperationResource in
                ...
                instance.returnType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["return_type"])
                instance.supportedOperators = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["supported_operators"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [DefaultOperationResource].self) { (source: AnyObject) -> [DefaultOperationResource] in
                return Decoders.decode(clazz: [DefaultOperationResource].self, source: source)
            }
            // Decoder for DefaultOperationResource
            Decoders.addDecoder(clazz: DefaultOperationResource.self) { (source: AnyObject) -> DefaultOperationResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = DefaultOperationResource()
                instance.args = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["args"])
                instance.definition = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["definition"])
                instance.op = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["op"])
                instance.returnType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["return_type"])
            ...
            Decoders.addDecoder(clazz: DeviceResource.self) { (source: AnyObject) -> DeviceResource in
                ...
                instance.owner = Decoders.decodeOptional(clazz: SimpleUserResource.self, source: sourceDictionary["owner"])
            ...
            Decoders.addDecoder(clazz: ForwardLog.self) { (source: AnyObject) -> ForwardLog in
                ...
                instance.eventId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["event_id"])
                instance.headers = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["headers"])
                ...
                instance.retryable = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["retryable"])
                instance.ruleId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["rule_id"])
                instance.startDate = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["start_date"])
            ...
            Decoders.addDecoder(clazz: GlobalCheckAndIncrementResource.self) { (source: AnyObject) -> GlobalCheckAndIncrementResource in
                ...
                instance.checkValueResource = Decoders.decodeOptional(clazz: ExpressionResource.self, source: sourceDictionary["check_value_resource"])
                instance.definition = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["definition"])
                instance.globalResource = Decoders.decodeOptional(clazz: ExpressionResource.self, source: sourceDictionary["global_resource"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: GlobalResource.self) { (source: AnyObject) -> GlobalResource in
                ...
                instance.definition = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["definition"])
                instance.globalDefId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["global_def_id"])
                instance.scopes = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["scopes"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: GoogleToken.self) { (source: AnyObject) -> GoogleToken in
                ...
                instance.authorizationCode = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["authorization_code"])
                return instance
            }
            ...
            // Decoder for [GroupMemberStatusWrapper]
            Decoders.addDecoder(clazz: [GroupMemberStatusWrapper].self) { (source: AnyObject) -> [GroupMemberStatusWrapper] in
                return Decoders.decode(clazz: [GroupMemberStatusWrapper].self, source: source)
            }
            // Decoder for GroupMemberStatusWrapper
            Decoders.addDecoder(clazz: GroupMemberStatusWrapper.self) { (source: AnyObject) -> GroupMemberStatusWrapper in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = GroupMemberStatusWrapper()
                instance.value = GroupMemberStatusWrapper.Value(rawValue: (sourceDictionary["value"] as? String) ?? "") 
                return instance
            }
            ...
            // Decoder for [InventoryStatusWrapper]
            Decoders.addDecoder(clazz: [InventoryStatusWrapper].self) { (source: AnyObject) -> [InventoryStatusWrapper] in
                return Decoders.decode(clazz: [InventoryStatusWrapper].self, source: source)
            }
            // Decoder for InventoryStatusWrapper
            Decoders.addDecoder(clazz: InventoryStatusWrapper.self) { (source: AnyObject) -> InventoryStatusWrapper in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = InventoryStatusWrapper()
                instance.value = InventoryStatusWrapper.Value(rawValue: (sourceDictionary["value"] as? String) ?? "") 
                return instance
            }
            ...
            Decoders.addDecoder(clazz: InventorySubscriptionResource.self) { (source: AnyObject) -> InventorySubscriptionResource in
                ...
                instance.priceOverride = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["price_override"])
                instance.priceOverrideReason = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["price_override_reason"])
            ...
            Decoders.addDecoder(clazz: InvoiceResource.self) { (source: AnyObject) -> InvoiceResource in
                ...
                instance.phoneNumber = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["phone_number"])
                instance.remainingBalance = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["remaining_balance"])
            ...
            Decoders.addDecoder(clazz: [ItemIdRequest].self) { (source: AnyObject) -> [ItemIdRequest] in
                return Decoders.decode(clazz: [ItemIdRequest].self, source: source)
            }
            // Decoder for ItemIdRequest
            Decoders.addDecoder(clazz: ItemIdRequest.self) { (source: AnyObject) -> ItemIdRequest in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ItemIdRequest()
                instance.itemId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["item_id"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: LimitedGettableGroup.self) { (source: AnyObject) -> LimitedGettableGroup in
                ...
                instance.activeOnly = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["active_only"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.ownedLimit = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["owned_limit"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: MapResource.self) { (source: AnyObject) -> MapResource in
                ...
                instance.definition = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["definition"])
                instance.map = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["map"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [ObjectResource].self) { (source: AnyObject) -> [ObjectResource] in
                return Decoders.decode(clazz: [ObjectResource].self, source: source)
            }
            // Decoder for ObjectResource
            Decoders.addDecoder(clazz: ObjectResource.self) { (source: AnyObject) -> ObjectResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ObjectResource()
                instance.behaviors = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["behaviors"])
                instance.category = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["category"])
                instance.createdDate = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["created_date"])
                instance.data = Decoders.decodeOptional(clazz: AnyObject.self, source: sourceDictionary["data"])
            ...
            Decoders.addDecoder(clazz: [OperationDefinitionResource].self) { (source: AnyObject) -> [OperationDefinitionResource] in
                return Decoders.decode(clazz: [OperationDefinitionResource].self, source: source)
            }
            // Decoder for OperationDefinitionResource
            Decoders.addDecoder(clazz: OperationDefinitionResource.self) { (source: AnyObject) -> OperationDefinitionResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = OperationDefinitionResource()
            ...
            Decoders.addDecoder(clazz: [OperationResource].self) { (source: AnyObject) -> [OperationResource] in
                return Decoders.decode(clazz: [OperationResource].self, source: source)
            }
            // Decoder for OperationResource
            Decoders.addDecoder(clazz: OperationResource.self) { (source: AnyObject) -> OperationResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = OperationResource()
                instance.args = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["args"])
                instance.definition = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["definition"])
                instance.op = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["op"])
                instance.returnType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["return_type"])
            ...
            Decoders.addDecoder(clazz: [PageResourceActivityOccurrenceResource].self) { (source: AnyObject) -> [PageResourceActivityOccurrenceResource] in
                return Decoders.decode(clazz: [PageResourceActivityOccurrenceResource].self, source: source)
            }
            // Decoder for PageResourceActivityOccurrenceResource
            Decoders.addDecoder(clazz: PageResourceActivityOccurrenceResource.self) { (source: AnyObject) -> PageResourceActivityOccurrenceResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PageResourceActivityOccurrenceResource()
                instance.content = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["content"])
                instance.first = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["first"])
                instance.last = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["last"])
                instance.number = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["number"])
            ...
            Decoders.addDecoder(clazz: [PageResourceFlagResource].self) { (source: AnyObject) -> [PageResourceFlagResource] in
                return Decoders.decode(clazz: [PageResourceFlagResource].self, source: source)
            }
            // Decoder for PageResourceFlagResource
            Decoders.addDecoder(clazz: PageResourceFlagResource.self) { (source: AnyObject) -> PageResourceFlagResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PageResourceFlagResource()
                instance.content = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["content"])
                instance.first = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["first"])
                instance.last = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["last"])
                instance.number = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["number"])
            ...
            Decoders.addDecoder(clazz: [PageResourceObjectResource].self) { (source: AnyObject) -> [PageResourceObjectResource] in
                return Decoders.decode(clazz: [PageResourceObjectResource].self, source: source)
            }
            // Decoder for PageResourceObjectResource
            Decoders.addDecoder(clazz: PageResourceObjectResource.self) { (source: AnyObject) -> PageResourceObjectResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PageResourceObjectResource()
                instance.content = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["content"])
                instance.first = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["first"])
                instance.last = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["last"])
                instance.number = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["number"])
            ...
            Decoders.addDecoder(clazz: [PageResourcePaymentMethodTypeResource].self) { (source: AnyObject) -> [PageResourcePaymentMethodTypeResource] in
                return Decoders.decode(clazz: [PageResourcePaymentMethodTypeResource].self, source: source)
            }
            // Decoder for PageResourcePaymentMethodTypeResource
            Decoders.addDecoder(clazz: PageResourcePaymentMethodTypeResource.self) { (source: AnyObject) -> PageResourcePaymentMethodTypeResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = PageResourcePaymentMethodTypeResource()
                instance.content = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["content"])
                instance.first = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["first"])
                instance.last = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["last"])
                instance.number = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["number"])
            ...
            Decoders.addDecoder(clazz: ParameterResource.self) { (source: AnyObject) -> ParameterResource in
                ...
                instance.definition = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["definition"])
                instance.of = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["of"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.value = Decoders.decodeOptional(clazz: AnyObject.self, source: sourceDictionary["value"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [Participant].self) { (source: AnyObject) -> [Participant] in
                return Decoders.decode(clazz: [Participant].self, source: source)
            }
            // Decoder for Participant
            Decoders.addDecoder(clazz: Participant.self) { (source: AnyObject) -> Participant in
                let sourceDictionary = source as! [NSObject:AnyObject]
                ...
                instance.host = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["host"])
                instance.status = Participant.Status(rawValue: (sourceDictionary["status"] as? String) ?? "") 
                instance.user = Decoders.decodeOptional(clazz: IdRef.self, source: sourceDictionary["user"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: PaymentMethodTypeResource.self) { (source: AnyObject) -> PaymentMethodTypeResource in
                ...
                instance.id = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["id"])
                instance.invoiceProcessingHours = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["invoice_processing_hours"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.supportsCapture = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_capture"])
                instance.supportsPartial = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_partial"])
                instance.supportsRebill = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_rebill"])
                instance.supportsRefunds = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["supports_refunds"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: PropertyFieldListResource.self) { (source: AnyObject) -> PropertyFieldListResource in
                ...
                instance.propertyDefinitionFields = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["property_definition_fields"])
                instance.propertyFields = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["property_fields"])
                instance.propertyType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["property_type"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: PropertyFieldResource.self) { (source: AnyObject) -> PropertyFieldResource in
                ...
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.innerType = PropertyFieldResource.InnerType(rawValue: (sourceDictionary["inner_type"] as? String) ?? "") 
                instance.innerTypeFields = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["inner_type_fields"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance._required = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["required"])
                instance.type = PropertyFieldResource.ModelType(rawValue: (sourceDictionary["type"] as? String) ?? "") 
                instance.validValues = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["valid_values"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [RawPushResource].self) { (source: AnyObject) -> [RawPushResource] in
                return Decoders.decode(clazz: [RawPushResource].self, source: source)
            }
            // Decoder for RawPushResource
            Decoders.addDecoder(clazz: RawPushResource.self) { (source: AnyObject) -> RawPushResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = RawPushResource()
                instance.recipients = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["recipients"])
                instance.text = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["text"])
                return instance
            }
            ...
            // Decoder for [ResourceTypeDescription]
            Decoders.addDecoder(clazz: [ResourceTypeDescription].self) { (source: AnyObject) -> [ResourceTypeDescription] in
                return Decoders.decode(clazz: [ResourceTypeDescription].self, source: source)
            }
            // Decoder for ResourceTypeDescription
            Decoders.addDecoder(clazz: ResourceTypeDescription.self) { (source: AnyObject) -> ResourceTypeDescription in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ResourceTypeDescription()
                instance.idField = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["id_field"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.servicePath = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["service_path"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: S3Config.self) { (source: AnyObject) -> S3Config in
                ...
                instance.bucketName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["bucket_name"])
                instance.cdnUrl = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["cdn_url"])
                instance.region = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["region"])
                instance.uploadPrefix = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["upload_prefix"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [SelectedSettingRequest].self) { (source: AnyObject) -> [SelectedSettingRequest] in
                return Decoders.decode(clazz: [SelectedSettingRequest].self, source: source)
            }
            // Decoder for SelectedSettingRequest
            Decoders.addDecoder(clazz: SelectedSettingRequest.self) { (source: AnyObject) -> SelectedSettingRequest in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = SelectedSettingRequest()
                instance.key = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["key"])
                instance.value = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["value"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: Sku.self) { (source: AnyObject) -> Sku in
                ...
                instance.notAvailable = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["not_available"])
                instance.notDisplayable = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["not_displayable"])
                instance.originalPrice = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["original_price"])
                instance.price = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["price"])
            ...
            Decoders.addDecoder(clazz: SubscriptionPlan.self) { (source: AnyObject) -> SubscriptionPlan in
                ...
                instance.additionalProperties = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["additional_properties"])
                instance.availability = SubscriptionPlan.Availability(rawValue: (sourceDictionary["availability"] as? String) ?? "") 
                instance.billGraceDays = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["bill_grace_days"])
                instance.consolidated = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["consolidated"])
                instance.firstBill = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["first_bill"])
                instance.firstBillUnitOfTime = SubscriptionPlan.FirstBillUnitOfTime(rawValue: (sourceDictionary["first_bill_unit_of_time"] as? String) ?? "") 
                instance.id = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["id"])
                instance.latePaymentSku = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["late_payment_sku"])
                instance.locked = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["locked"])
                instance.maxAutoRenew = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["max_auto_renew"])
                instance.maxBillAttempts = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["max_bill_attempts"])
                instance.migrationPlan = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["migration_plan"])
                instance.minimumTerm = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["minimum_term"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                instance.primarySku = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["primary_sku"])
                ...
                instance.renewPeriod = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["renew_period"])
                instance.renewPeriodUnitOfTime = SubscriptionPlan.RenewPeriodUnitOfTime(rawValue: (sourceDictionary["renew_period_unit_of_time"] as? String) ?? "") 
                instance.subscriptionId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["subscription_id"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [SubscriptionPriceOverrideRequest].self) { (source: AnyObject) -> [SubscriptionPriceOverrideRequest] in
                return Decoders.decode(clazz: [SubscriptionPriceOverrideRequest].self, source: source)
            }
            // Decoder for SubscriptionPriceOverrideRequest
            Decoders.addDecoder(clazz: SubscriptionPriceOverrideRequest.self) { (source: AnyObject) -> SubscriptionPriceOverrideRequest in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = SubscriptionPriceOverrideRequest()
            ...
            // Decoder for [SubscriptionStatusWrapper]
            Decoders.addDecoder(clazz: [SubscriptionStatusWrapper].self) { (source: AnyObject) -> [SubscriptionStatusWrapper] in
                return Decoders.decode(clazz: [SubscriptionStatusWrapper].self, source: source)
            }
            // Decoder for SubscriptionStatusWrapper
            Decoders.addDecoder(clazz: SubscriptionStatusWrapper.self) { (source: AnyObject) -> SubscriptionStatusWrapper in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = SubscriptionStatusWrapper()
                instance.value = SubscriptionStatusWrapper.Value(rawValue: (sourceDictionary["value"] as? String) ?? "") 
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [TemplatePushResource].self) { (source: AnyObject) -> [TemplatePushResource] in
                return Decoders.decode(clazz: [TemplatePushResource].self, source: source)
            }
            // Decoder for TemplatePushResource
            Decoders.addDecoder(clazz: TemplatePushResource.self) { (source: AnyObject) -> TemplatePushResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = TemplatePushResource()
                instance.recipients = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["recipients"])
                instance.template = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["template"])
                instance.templateVars = Decoders.decodeOptional(clazz: AnyObject.self, source: sourceDictionary["template_vars"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [UserActivityResults].self) { (source: AnyObject) -> [UserActivityResults] in
                return Decoders.decode(clazz: [UserActivityResults].self, source: source)
            }
            // Decoder for UserActivityResults
            Decoders.addDecoder(clazz: UserActivityResults.self) { (source: AnyObject) -> UserActivityResults in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = UserActivityResults()
                instance.currencyRewards = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["currency_rewards"])
                instance.itemRewards = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["item_rewards"])
                instance.rank = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["rank"])
                instance.score = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["score"])
            ...
            Decoders.addDecoder(clazz: UserBaseResource.self) { (source: AnyObject) -> UserBaseResource in
                ...
                instance.lastUpdated = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["last_updated"])
                instance.memberSince = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["member_since"])
                instance.username = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["username"])
                return instance
            }
            ...
            // Decoder for [UserNotificationStatusWrapper]
            Decoders.addDecoder(clazz: [UserNotificationStatusWrapper].self) { (source: AnyObject) -> [UserNotificationStatusWrapper] in
                return Decoders.decode(clazz: [UserNotificationStatusWrapper].self, source: source)
            }
            // Decoder for UserNotificationStatusWrapper
            Decoders.addDecoder(clazz: UserNotificationStatusWrapper.self) { (source: AnyObject) -> UserNotificationStatusWrapper in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = UserNotificationStatusWrapper()
                instance.value = UserNotificationStatusWrapper.Value(rawValue: (sourceDictionary["value"] as? String) ?? "") 
                return instance
            }
            ...
            Decoders.addDecoder(clazz: VariableTypeResource.self) { (source: AnyObject) -> VariableTypeResource in
                ...
                instance.enumerable = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["enumerable"])
                instance.name = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["name"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: Consumable.self) { (source: AnyObject) -> Consumable in
                ...
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.typeHint = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type_hint"])
                instance.maxUse = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["max_use"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: DatePropertyDefinitionResource.self) { (source: AnyObject) -> DatePropertyDefinitionResource in
                ...
                instance.min = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["min"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: Expirable.self) { (source: AnyObject) -> Expirable in
                ...
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.typeHint = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type_hint"])
                instance.timeLength = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["time_length"])
                instance.unitOfTime = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["unit_of_time"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: FileGroupPropertyDefinitionResource.self) { (source: AnyObject) -> FileGroupPropertyDefinitionResource in
                ...
                instance.maxFileSize = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["max_file_size"])
                instance.minCount = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["min_count"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: FileProperty.self) { (source: AnyObject) -> FileProperty in
                ...
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.crc = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["crc"])
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.fileType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["file_type"])
                instance.url = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["url"])
                return instance
            ...
            Decoders.addDecoder(clazz: GuestPlayable.self) { (source: AnyObject) -> GuestPlayable in
                ...
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.typeHint = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type_hint"])
                instance.allowed = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["allowed"])
                instance.leaderboard = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["leaderboard"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: ImagePropertyDefinitionResource.self) { (source: AnyObject) -> ImagePropertyDefinitionResource in
                ...
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.fileType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["file_type"])
                instance.maxHeight = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["max_height"])
                instance.maxWidth = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["max_width"])
            ...
            Decoders.addDecoder(clazz: [ListProperty].self) { (source: AnyObject) -> [ListProperty] in
                return Decoders.decode(clazz: [ListProperty].self, source: source)
            }
            // Decoder for ListProperty
            Decoders.addDecoder(clazz: ListProperty.self) { (source: AnyObject) -> ListProperty in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ListProperty()
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
            ...
            Decoders.addDecoder(clazz: [ListPropertyDefinitionResource].self) { (source: AnyObject) -> [ListPropertyDefinitionResource] in
                return Decoders.decode(clazz: [ListPropertyDefinitionResource].self, source: source)
            }
            // Decoder for ListPropertyDefinitionResource
            Decoders.addDecoder(clazz: ListPropertyDefinitionResource.self) { (source: AnyObject) -> ListPropertyDefinitionResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                ...
                instance.maxCount = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["max_count"])
                instance.minCount = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["min_count"])
                instance.valueDefinition = Decoders.decodeOptional(clazz: PropertyDefinitionResource.self, source: sourceDictionary["value_definition"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [MapProperty].self) { (source: AnyObject) -> [MapProperty] in
                return Decoders.decode(clazz: [MapProperty].self, source: source)
            }
            // Decoder for MapProperty
            Decoders.addDecoder(clazz: MapProperty.self) { (source: AnyObject) -> MapProperty in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = MapProperty()
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.map = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["map"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [MapPropertyDefinitionResource].self) { (source: AnyObject) -> [MapPropertyDefinitionResource] in
                return Decoders.decode(clazz: [MapPropertyDefinitionResource].self, source: source)
            }
            // Decoder for MapPropertyDefinitionResource
            Decoders.addDecoder(clazz: MapPropertyDefinitionResource.self) { (source: AnyObject) -> MapPropertyDefinitionResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
            ...
            Decoders.addDecoder(clazz: [MobileDeviceResource].self) { (source: AnyObject) -> [MobileDeviceResource] in
                return Decoders.decode(clazz: [MobileDeviceResource].self, source: source)
            }
            // Decoder for MobileDeviceResource
            Decoders.addDecoder(clazz: MobileDeviceResource.self) { (source: AnyObject) -> MobileDeviceResource in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = MobileDeviceResource()
                instance.additionalProperties = Decoders.decodeOptional(clazz: Dictionary.self, source: sourceDictionary["additional_properties"])
                instance.createdDate = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["created_date"])
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.deviceType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["device_type"])
                ...
                instance.notificationPlatform = MobileDeviceResource.NotificationPlatform(rawValue: (sourceDictionary["notification_platform"] as? String) ?? "") 
            ...
            Decoders.addDecoder(clazz: NewCustomerEvent.self) { (source: AnyObject) -> NewCustomerEvent in
                ...
                instance.timestamp = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["timestamp"])
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.customerConfig = Decoders.decodeOptional(clazz: CustomerConfig.self, source: sourceDictionary["customer_config"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: PreReqEntitlement.self) { (source: AnyObject) -> PreReqEntitlement in
                ...
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.typeHint = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type_hint"])
                instance.itemIds = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["item_ids"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: [RemoveCustomerEvent].self) { (source: AnyObject) -> [RemoveCustomerEvent] in
                return Decoders.decode(clazz: [RemoveCustomerEvent].self, source: source)
            }
            // Decoder for RemoveCustomerEvent
            Decoders.addDecoder(clazz: RemoveCustomerEvent.self) { (source: AnyObject) -> RemoveCustomerEvent in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = RemoveCustomerEvent()
                instance.client = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["client"])
                instance.customer = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["customer"])
                instance.doNotBroadcast = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["do_not_broadcast"])
                instance.section = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["section"])
            ...
            // Decoder for [ServiceDeployedEvent]
            Decoders.addDecoder(clazz: [ServiceDeployedEvent].self) { (source: AnyObject) -> [ServiceDeployedEvent] in
                return Decoders.decode(clazz: [ServiceDeployedEvent].self, source: source)
            }
            // Decoder for ServiceDeployedEvent
            Decoders.addDecoder(clazz: ServiceDeployedEvent.self) { (source: AnyObject) -> ServiceDeployedEvent in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ServiceDeployedEvent()
                instance.client = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["client"])
                instance.customer = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["customer"])
                instance.doNotBroadcast = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["do_not_broadcast"])
                instance.section = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["section"])
                ...
                instance.serviceName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["service_name"])
                instance.swaggerUrl = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["swagger_url"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: TimePeriodGettable.self) { (source: AnyObject) -> TimePeriodGettable in
                ...
                instance.description = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["description"])
                instance.typeHint = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type_hint"])
                instance.getLimit = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["get_limit"])
                instance.groupName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["group_name"])
                instance.timeLength = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["time_length"])
                instance.unitOfTime = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["unit_of_time"])
                return instance
            ...
            Decoders.addDecoder(clazz: AudioGroupProperty.self) { (source: AnyObject) -> AudioGroupProperty in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = AudioGroupProperty()
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.files = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["files"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: ImageGroupProperty.self) { (source: AnyObject) -> ImageGroupProperty in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = ImageGroupProperty()
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.files = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["files"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: Subscription.self) { (source: AnyObject) -> Subscription in
                ...
                instance.displayable = Decoders.decodeOptional(clazz: Bool.self, source: sourceDictionary["displayable"])
                instance.geoCountryList = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["geo_country_list"])
                instance.geoPolicyType = Subscription.GeoPolicyType(rawValue: (sourceDictionary["geo_policy_type"] as? String) ?? "") 
                instance.shippingTier = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["shipping_tier"])
                instance.skus = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["skus"])
                instance.storeEnd = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["store_end"])
                instance.storeStart = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["store_start"])
                instance.vendorId = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["vendor_id"])
                instance.availability = Subscription.Availability(rawValue: (sourceDictionary["availability"] as? String) ?? "") 
                instance.consolidationDayOfMonth = Decoders.decodeOptional(clazz: Int32.self, source: sourceDictionary["consolidation_day_of_month"])
                instance.subscriptionPlans = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["subscription_plans"])
                return instance
            }
            ...
            Decoders.addDecoder(clazz: VideoGroupProperty.self) { (source: AnyObject) -> VideoGroupProperty in
                let sourceDictionary = source as! [NSObject:AnyObject]
                let instance = VideoGroupProperty()
                instance.type = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["type"])
                instance.files = Decoders.decodeOptional(clazz: Array.self, source: sourceDictionary["files"])
                return instance
            }
