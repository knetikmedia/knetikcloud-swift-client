...
public class AuthClientsAPI: APIBase {
  ...
  "refresh_token_validity_seconds" : 123
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getClientsUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceClientResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getClientsUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceClientResource> {
        let path = "/auth/clients"
        let URLString = SwaggerClientAPI.basePath + path
