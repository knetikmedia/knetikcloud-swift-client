...
public class AuthPermissionsAPI: APIBase {
  ...
  "locked" : false
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getPermissionUsingGET1(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourcePermissionResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getPermissionUsingGET1WithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourcePermissionResource> {
        let path = "/auth/permissions"
        let URLString = SwaggerClientAPI.basePath + path
