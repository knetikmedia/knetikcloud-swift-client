...
public class AuthRolesAPI: APIBase {
  ...
  "client_count" : 123
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getRolesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceRoleResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getRolesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceRoleResource> {
        let path = "/auth/roles"
        let URLString = SwaggerClientAPI.basePath + path
