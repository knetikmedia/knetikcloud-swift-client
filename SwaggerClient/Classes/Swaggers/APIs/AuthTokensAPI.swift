...
public class AuthTokensAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTokensUsingGET(filterClientId filterClientId: String? = nil, filterUsername: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageOauthAccessTokenResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getTokensUsingGETWithRequestBuilder(filterClientId filterClientId: String? = nil, filterUsername: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageOauthAccessTokenResource> {
