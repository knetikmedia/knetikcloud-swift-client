...
public class BRERuleEngineCategoriesAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCategoriesUsingGET(size size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceBreCategoryResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getCategoriesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBreCategoryResource> {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTemplatesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceTemplateResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getTemplatesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceTemplateResource> {
        let path = "/bre/categories/templates"
        let URLString = SwaggerClientAPI.basePath + path
