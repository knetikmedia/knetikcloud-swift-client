...
public class BRERuleEngineEventsAPI: APIBase {
     ...
     */
    public class func fireEventUsingPOST(breEvent breEvent: BreEvent? = nil, authentication: OAuth2Authentication? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func fireEventUsingPOSTWithRequestBuilder(breEvent breEvent: BreEvent? = nil, authentication: OAuth2Authentication? = nil) -> RequestBuilder<Void> {
        let path = "/bre/events"
