...
public class BRERuleEngineGlobalsAPI: APIBase {
  ...
  "key" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getGlobalsUsingGET(filterSystem filterSystem: Bool? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceBreGlobalResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getGlobalsUsingGETWithRequestBuilder(filterSystem filterSystem: Bool? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBreGlobalResource> {
        let path = "/bre/globals/definitions"
        let URLString = SwaggerClientAPI.basePath + path
