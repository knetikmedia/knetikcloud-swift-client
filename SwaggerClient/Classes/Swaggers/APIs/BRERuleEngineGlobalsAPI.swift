...
public class BRERuleEngineGlobalsAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateBREGlobal(id id: String, breGlobalResource: BreGlobalResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateBREGlobalWithRequestBuilder(id id: String, breGlobalResource: BreGlobalResource? = nil) -> RequestBuilder<Void> {
        var path = "/bre/globals/definitions/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = breGlobalResource?.encodeToJSON() as? [String:AnyObject]
