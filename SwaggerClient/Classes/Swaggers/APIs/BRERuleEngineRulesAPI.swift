...
public class BRERuleEngineRulesAPI: APIBase {
  ...
  "start_date" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getRulesUsingGET(filterName filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageBreRule?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getRulesUsingGETWithRequestBuilder(filterName filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageBreRule> {
        let path = "/bre/rules"
        let URLString = SwaggerClientAPI.basePath + path
