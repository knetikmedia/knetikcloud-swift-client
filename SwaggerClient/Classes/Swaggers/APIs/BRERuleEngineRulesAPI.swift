...
public class BRERuleEngineRulesAPI: APIBase {
     ...
     */
    public class func convertExpressionToStringUsingPOST(expression expression: Expressionobject? = nil, completion: ((data: String?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func convertExpressionToStringUsingPOSTWithRequestBuilder(expression expression: Expressionobject? = nil) -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func createRuleUsingPOST(breRule breRule: BreRule? = nil, completion: ((data: BreRule?, error: ErrorType?) -> Void)) {
  ...
  "start_date" : 123456789
     ...
     */
    public class func createRuleUsingPOSTWithRequestBuilder(breRule breRule: BreRule? = nil) -> RequestBuilder<BreRule> {
        let path = "/bre/rules"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteRuleUsingDELETE(id id: String, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func deleteRuleUsingDELETEWithRequestBuilder(id id: String) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func enableRuleUsingPUT(id id: String, enabled: BooleanResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func enableRuleUsingPUTWithRequestBuilder(id id: String, enabled: BooleanResource? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getRuleUsingGET(id id: String, completion: ((data: BreRule?, error: ErrorType?) -> Void)) {
  ...
  "start_date" : 123456789
     ...
     - returns: RequestBuilder<BreRule> 
     */
    public class func getRuleUsingGETWithRequestBuilder(id id: String) -> RequestBuilder<BreRule> {
        var path = "/bre/rules/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getRulesUsingGET(filterName filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceBreRule?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getRulesUsingGETWithRequestBuilder(filterName filterName: String? = nil, filterEnabled: Bool? = nil, filterSystem: Bool? = nil, filterTrigger: String? = nil, filterAction: String? = nil, filterCondition: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBreRule> {
        let path = "/bre/rules"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateRuleUsingPUT(id id: String, breRule: BreRule? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateRuleUsingPUTWithRequestBuilder(id id: String, breRule: BreRule? = nil) -> RequestBuilder<Void> {
        var path = "/bre/rules/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = breRule?.encodeToJSON() as? [String:AnyObject]
