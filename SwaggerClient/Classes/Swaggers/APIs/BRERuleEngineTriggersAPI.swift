...
public class BRERuleEngineTriggersAPI: APIBase {
  ...
  "trigger_description" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTriggersUsingGET(filterSystem filterSystem: Bool? = nil, filterCategory: FilterCategory_getTriggersUsingGET? = nil, filterName: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceBreTriggerResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getTriggersUsingGETWithRequestBuilder(filterSystem filterSystem: Bool? = nil, filterCategory: FilterCategory_getTriggersUsingGET? = nil, filterName: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBreTriggerResource> {
        let path = "/bre/triggers"
        let URLString = SwaggerClientAPI.basePath + path
