...
public class CampaignsChallengesAPI: APIBase {
  ...
  "start_date" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateChallengeActivity(activityId activityId: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateChallengeActivityWithRequestBuilder(activityId activityId: Int64, challengeId: Int64, challengeActivityResource: ChallengeActivityResource? = nil) -> RequestBuilder<Void> {
        var path = "/challenges/{challengeId}/activities/{activityId}"
        path = path.stringByReplacingOccurrencesOfString("{activity_id}", withString: "\(activityId)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{challenge_id}", withString: "\(challengeId)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateChallengeTemplate(id id: String, challengeTemplateResource: TemplateResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateChallengeTemplateWithRequestBuilder(id id: String, challengeTemplateResource: TemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/challenges/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = challengeTemplateResource?.encodeToJSON() as? [String:AnyObject]
