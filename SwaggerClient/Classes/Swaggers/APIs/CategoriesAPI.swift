...
public class CategoriesAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTagsUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: Pagestring?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getTagsUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<Pagestring> {
        let path = "/tags"
        let URLString = SwaggerClientAPI.basePath + path
