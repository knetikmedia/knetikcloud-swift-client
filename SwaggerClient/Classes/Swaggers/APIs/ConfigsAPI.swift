...
public class ConfigsAPI: APIBase {
  ...
  "value" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getConfigsUsingGET(filterSearch filterSearch: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceConfig?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getConfigsUsingGETWithRequestBuilder(filterSearch filterSearch: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceConfig> {
        let path = "/configs"
        let URLString = SwaggerClientAPI.basePath + path
