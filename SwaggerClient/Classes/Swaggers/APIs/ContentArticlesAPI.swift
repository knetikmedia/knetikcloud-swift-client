...
public class ContentArticlesAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateArticle(id id: String, articleResource: ArticleResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateArticleWithRequestBuilder(id id: String, articleResource: ArticleResource? = nil) -> RequestBuilder<Void> {
        var path = "/content/articles/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = articleResource?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateArticleTemplate(id id: String, articleTemplateResource: TemplateResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateArticleTemplateWithRequestBuilder(id id: String, articleTemplateResource: TemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/content/articles/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = articleTemplateResource?.encodeToJSON() as? [String:AnyObject]
