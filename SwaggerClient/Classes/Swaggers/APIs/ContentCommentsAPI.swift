...
public class ContentCommentsAPI: APIBase {
  ...
  "content" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCommentsUsingGET(context context: String, contextId: Int32, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceCommentResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getCommentsUsingGETWithRequestBuilder(context context: String, contextId: Int32, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceCommentResource> {
        let path = "/comments"
        let URLString = SwaggerClientAPI.basePath + path
