...
public class ContentPollsAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updatePoll(id id: String, pollResource: PollResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updatePollWithRequestBuilder(id id: String, pollResource: PollResource? = nil) -> RequestBuilder<Void> {
        var path = "/media/polls/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = pollResource?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updatePollTemplate(id id: String, pollTemplateResource: TemplateResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updatePollTemplateWithRequestBuilder(id id: String, pollTemplateResource: TemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/media/polls/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = pollTemplateResource?.encodeToJSON() as? [String:AnyObject]
