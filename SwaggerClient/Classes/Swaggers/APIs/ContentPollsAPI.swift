...
public class ContentPollsAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getPollTemplatesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageTemplateResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getPollTemplatesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageTemplateResource> {
        let path = "/media/polls/templates"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getPollsUsingGET(filterCategory filterCategory: String? = nil, filterTagset: String? = nil, filterText: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PagePollResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getPollsUsingGETWithRequestBuilder(filterCategory filterCategory: String? = nil, filterTagset: String? = nil, filterText: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PagePollResource> {
        let path = "/media/polls"
        let URLString = SwaggerClientAPI.basePath + path
