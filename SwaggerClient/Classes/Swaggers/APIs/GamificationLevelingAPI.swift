...
public class GamificationLevelingAPI: APIBase {
  ...
  "updated_date" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getLevelsUsingGET(filterName filterName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceLevelingResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getLevelsUsingGETWithRequestBuilder(filterName filterName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceLevelingResource> {
        let path = "/leveling"
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "next_tier_progress" : 123
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserLevelsUsingGET(userId userId: Int32, completion: ((data: PageResourceUserLevelingResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getUserLevelsUsingGETWithRequestBuilder(userId userId: Int32) -> RequestBuilder<PageResourceUserLevelingResource> {
