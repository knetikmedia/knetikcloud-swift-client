...
public class GamificationTriviaAPI: APIBase {
  ...
  "tags" : [ "aeiou" ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getQuestionTags1(filterSearch filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil, completion: ((data: Collectionstring?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getQuestionTags1WithRequestBuilder(filterSearch filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil) -> RequestBuilder<Collectionstring> {
