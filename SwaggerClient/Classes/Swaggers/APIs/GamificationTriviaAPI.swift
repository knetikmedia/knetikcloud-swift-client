...
public class GamificationTriviaAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getListUsingGET1(filterVendor filterVendor: String? = nil, filterCategory: String? = nil, filterName: String? = nil, filterStatus: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageImportJobResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getListUsingGET1WithRequestBuilder(filterVendor filterVendor: String? = nil, filterCategory: String? = nil, filterName: String? = nil, filterStatus: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageImportJobResource> {
        let path = "/trivia/import"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getQuestionTemplatesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageQuestionTemplateResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getQuestionTemplatesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageQuestionTemplateResource> {
        let path = "/trivia/questions/templates"
        let URLString = SwaggerClientAPI.basePath + path
