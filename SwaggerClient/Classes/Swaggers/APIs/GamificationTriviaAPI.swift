...
public class GamificationTriviaAPI: APIBase {
  ...
  "status" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func searchQuestionTags(filterSearch filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil, completion: ((data: Collectionstring?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func searchQuestionTagsWithRequestBuilder(filterSearch filterSearch: String? = nil, filterCategory: String? = nil, filterImportId: Int64? = nil) -> RequestBuilder<Collectionstring> {
