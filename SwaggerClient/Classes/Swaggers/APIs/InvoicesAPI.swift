...
public class InvoicesAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func listFulFillmentStatuses(completion: ((data: [String]?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func listFulFillmentStatusesWithRequestBuilder() -> RequestBuilder<[String]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func listPaymentStatuses(completion: ((data: [String]?, error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    public class func listPaymentStatusesWithRequestBuilder() -> RequestBuilder<[String]> {
