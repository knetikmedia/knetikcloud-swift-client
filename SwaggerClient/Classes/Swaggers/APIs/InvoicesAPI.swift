...
public class InvoicesAPI: APIBase {
  ...
  "shipping_postal_code" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getLogsUsingGET(id id: Int32, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceInvoiceLogEntry?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getLogsUsingGETWithRequestBuilder(id id: Int32, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceInvoiceLogEntry> {
