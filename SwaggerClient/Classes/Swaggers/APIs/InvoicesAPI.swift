...
public class InvoicesAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getInvoiceUsingGET(id id: Int32, completion: ((data: InvoiceResource?, error: ErrorType?) -> Void)) {
  ...
  "shipping_postal_code" : "aeiou"
     ...
     - returns: RequestBuilder<InvoiceResource> 
     */
    public class func getInvoiceUsingGETWithRequestBuilder(id id: Int32) -> RequestBuilder<InvoiceResource> {
