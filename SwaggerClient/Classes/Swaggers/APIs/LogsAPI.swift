...
public class LogsAPI: APIBase {
  ...
  "customer" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getEventsLogsUsingGET(filterStartDate filterStartDate: String? = nil, filterEventName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceBreEventLog?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getEventsLogsUsingGETWithRequestBuilder(filterStartDate filterStartDate: String? = nil, filterEventName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceBreEventLog> {
  ...
  "start_date" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getForwardLogsUsingGET(filterStartDate filterStartDate: String? = nil, filterEndDate: String? = nil, filterStatusCode: Int32? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceForwardLog?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getForwardLogsUsingGETWithRequestBuilder(filterStartDate filterStartDate: String? = nil, filterEndDate: String? = nil, filterStatusCode: Int32? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceForwardLog> {
  ...
  "request_id" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserLogsUsingGET1(filterUser filterUser: Int32? = nil, filterActionName: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceUserActionLog?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getUserLogsUsingGET1WithRequestBuilder(filterUser filterUser: Int32? = nil, filterActionName: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceUserActionLog> {
        let path = "/audit/logs"
        let URLString = SwaggerClientAPI.basePath + path
