...
public class LogsAPI: APIBase {
  ...
  "customer" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getBREEventLogs(filterStartDate filterStartDate: String? = nil, filterEventName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceBreEventLog?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getBREEventLogsWithRequestBuilder(filterStartDate filterStartDate: String? = nil, filterEventName: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceBreEventLog> {
  ...
  "request_id" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserLogs(filterUser filterUser: Int32? = nil, filterActionName: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceUserActionLog?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getUserLogsWithRequestBuilder(filterUser filterUser: Int32? = nil, filterActionName: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceUserActionLog> {
        let path = "/audit/logs"
        let URLString = SwaggerClientAPI.basePath + path
