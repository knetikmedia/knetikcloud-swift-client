...
public class MediaModerationAPI: APIBase {
     ...
     */
    public class func getModerationReport(id id: Int64, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func getModerationReportWithRequestBuilder(id id: Int64) -> RequestBuilder<Void> {
