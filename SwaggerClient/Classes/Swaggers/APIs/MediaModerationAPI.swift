...
public class MediaModerationAPI: APIBase {
  ...
  "resolved" : 2
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getModerationReports(excludeResolved excludeResolved: Bool? = nil, filterContext: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceFlagReportResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getModerationReportsWithRequestBuilder(excludeResolved excludeResolved: Bool? = nil, filterContext: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceFlagReportResource> {
