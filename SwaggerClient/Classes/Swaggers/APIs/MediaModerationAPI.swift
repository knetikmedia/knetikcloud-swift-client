...
public class MediaModerationAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getFlagsReportUsingGET(excludeResolved excludeResolved: Bool? = nil, filterContext: String? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageFlagReportResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getFlagsReportUsingGETWithRequestBuilder(excludeResolved excludeResolved: Bool? = nil, filterContext: String? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageFlagReportResource> {
