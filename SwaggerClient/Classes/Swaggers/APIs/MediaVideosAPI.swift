...
public class MediaVideosAPI: APIBase {
  ...
  "category" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCommentsUsingGET1(videoId videoId: Int32, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceCommentResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getCommentsUsingGET1WithRequestBuilder(videoId videoId: Int32, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceCommentResource> {
        var path = "/media/videos/{videoId}/comments"
        path = path.stringByReplacingOccurrencesOfString("{video_id}", withString: "\(videoId)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getDispositionsUsingGET1(videoId videoId: Int32, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceDispositionResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getDispositionsUsingGET1WithRequestBuilder(videoId videoId: Int32, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceDispositionResource> {
        var path = "/media/videos/{videoId}/dispositions"
        path = path.stringByReplacingOccurrencesOfString("{video_id}", withString: "\(videoId)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getRelatedUsingGET(videoId videoId: Int64, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceVideoRelationshipResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getRelatedUsingGETWithRequestBuilder(videoId videoId: Int64, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceVideoRelationshipResource> {
        var path = "/media/videos/{videoId}/related"
        path = path.stringByReplacingOccurrencesOfString("{video_id}", withString: "\(videoId)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserVideosUsingGET(userId userId: Int32, excludeFlagged: Bool? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceVideoResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getUserVideosUsingGETWithRequestBuilder(userId userId: Int32, excludeFlagged: Bool? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceVideoResource> {
