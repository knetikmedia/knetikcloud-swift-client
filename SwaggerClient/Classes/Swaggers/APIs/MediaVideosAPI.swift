...
public class MediaVideosAPI: APIBase {
  ...
  "content" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func addVideoFlag(videoId videoId: Int64, reason: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func addVideoFlagWithRequestBuilder(videoId videoId: Int64, reason: String? = nil) -> RequestBuilder<Void> {
