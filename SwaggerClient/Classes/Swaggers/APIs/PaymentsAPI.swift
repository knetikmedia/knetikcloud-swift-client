...
public class PaymentsAPI: APIBase {
  ...
  "invoice" : 123
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updatePaymentMethod(userId userId: Int32, id: Int32, paymentMethod: PaymentMethodResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updatePaymentMethodWithRequestBuilder(userId userId: Int32, id: Int32, paymentMethod: PaymentMethodResource? = nil) -> RequestBuilder<Void> {
        var path = "/users/{userId}/payment-methods/{id}"
        path = path.stringByReplacingOccurrencesOfString("{user_id}", withString: "\(userId)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
