...
public class PaymentsStripeAPI: APIBase {
     ...
     */
    public class func createCustomerUsingPOST1(request request: StripeCreatePaymentMethod? = nil, completion: ((data: PaymentMethodResource?, error: ErrorType?) -> Void)) {
  ...
  "updated_date" : 123456789
     ...
     */
    public class func createCustomerUsingPOST1WithRequestBuilder(request request: StripeCreatePaymentMethod? = nil) -> RequestBuilder<PaymentMethodResource> {
