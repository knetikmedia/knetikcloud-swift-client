...
public class PaymentsWalletsAPI: APIBase {
     ...
     */
    public class func getWalletTotalsUsingGET(completion: ((data: PageResourceWalletTotalResponse?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getWalletTotalsUsingGETWithRequestBuilder() -> RequestBuilder<PageResourceWalletTotalResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getWalletUsingGET(userId userId: Int32, currencyCode: String, completion: ((data: SimpleWallet?, error: ErrorType?) -> Void)) {
  ...
  "id" : 123
     ...
     */
    public class func getWalletUsingGETWithRequestBuilder(userId userId: Int32, currencyCode: String) -> RequestBuilder<SimpleWallet> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getWalletsUsingGET(userId userId: Int32, completion: ((data: [SimpleWallet]?, error: ErrorType?) -> Void)) {
  ...
  "id" : 123
     ...
     - returns: RequestBuilder<[SimpleWallet]> 
     */
    public class func getWalletsUsingGETWithRequestBuilder(userId userId: Int32) -> RequestBuilder<[SimpleWallet]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getWalletsUsingGET1(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceSimpleWallet?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getWalletsUsingGET1WithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceSimpleWallet> {
        let path = "/wallets"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func transactionHistoryUsingGET(filterInvoice filterInvoice: Int32? = nil, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: FilterSign_transactionHistoryUsingGET? = nil, filterUserId: Int32? = nil, filterUsername: String? = nil, filterDetails: String? = nil, filterCurrencyCode: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceWalletTransactionResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateBalanceUsingPUT(userId userId: Int32, currencyCode: String, request: WalletAlterRequest? = nil, completion: ((data: WalletTransactionResource?, error: ErrorType?) -> Void)) {
  ...
  "successful" : false
     ...
     */
    public class func updateBalanceUsingPUTWithRequestBuilder(userId userId: Int32, currencyCode: String, request: WalletAlterRequest? = nil) -> RequestBuilder<WalletTransactionResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func userTransactionHistoryUsingGET(userId userId: Int32, currencyCode: String, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceWalletTransactionResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceWalletTransactionResource> 
     */
    public class func userTransactionHistoryUsingGETWithRequestBuilder(userId userId: Int32, currencyCode: String, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceWalletTransactionResource> {
