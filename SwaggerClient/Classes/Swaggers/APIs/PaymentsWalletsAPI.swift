...
public class PaymentsWalletsAPI: APIBase {
     ...
     */
    public class func getWalletTotalsUsingGET(completion: ((data: PageWalletTotalResponse?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getWalletTotalsUsingGETWithRequestBuilder() -> RequestBuilder<PageWalletTotalResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getWalletsUsingGET1(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageSimpleWallet?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getWalletsUsingGET1WithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageSimpleWallet> {
        let path = "/wallets"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func userTransactionHistoryUsingGET(userId userId: Int32, currencyCode: String, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageWalletTransactionResource?, error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<PageWalletTransactionResource> 
     */
    public class func userTransactionHistoryUsingGETWithRequestBuilder(userId userId: Int32, currencyCode: String, filterType: String? = nil, filterMaxDate: Int64? = nil, filterMinDate: Int64? = nil, filterSign: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageWalletTransactionResource> {
