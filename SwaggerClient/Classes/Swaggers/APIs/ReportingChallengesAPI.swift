...
public class ReportingChallengesAPI: APIBase {
     ...
     */
    public class func getChallengeEventLeaderboardUsingGET(filterEvent filterEvent: Int64? = nil, completion: ((data: PageChallengeEventParticipantResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getChallengeEventLeaderboardUsingGETWithRequestBuilder(filterEvent filterEvent: Int64? = nil) -> RequestBuilder<PageChallengeEventParticipantResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getChallengeEventParticipantsUsingGET(filterEvent filterEvent: Int64? = nil, completion: ((data: PageChallengeEventParticipantResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageChallengeEventParticipantResource> 
     */
    public class func getChallengeEventParticipantsUsingGETWithRequestBuilder(filterEvent filterEvent: Int64? = nil) -> RequestBuilder<PageChallengeEventParticipantResource> {
