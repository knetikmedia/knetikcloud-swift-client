...
public class ReportingOrdersAPI: APIBase {
     ...
     */
    public class func getDailyInvoicesUsingGET(currencyCode currencyCode: String, granularity: Granularity_getDailyInvoicesUsingGET? = nil, filterPaymentStatus: String? = nil, filterFulfillmentStatus: String? = nil, startDate: Int64? = nil, endDate: Int64? = nil, completion: ((data: PageResourceAggregateInvoiceReportResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getDailyInvoicesUsingGETWithRequestBuilder(currencyCode currencyCode: String, granularity: Granularity_getDailyInvoicesUsingGET? = nil, filterPaymentStatus: String? = nil, filterFulfillmentStatus: String? = nil, startDate: Int64? = nil, endDate: Int64? = nil) -> RequestBuilder<PageResourceAggregateInvoiceReportResource> {
