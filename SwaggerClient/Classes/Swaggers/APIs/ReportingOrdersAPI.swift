...
public class ReportingOrdersAPI: APIBase {
     ...
     */
    public class func getDailyInvoicesUsingGET(currencyCode currencyCode: String, granularity: Granularity_getDailyInvoicesUsingGET? = nil, filterPaymentStatus: String? = nil, filterFulfillmentStatus: String? = nil, startDate: Int64? = nil, endDate: Int64? = nil, completion: ((data: PageAggregateInvoiceReportResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getDailyInvoicesUsingGETWithRequestBuilder(currencyCode currencyCode: String, granularity: Granularity_getDailyInvoicesUsingGET? = nil, filterPaymentStatus: String? = nil, filterFulfillmentStatus: String? = nil, startDate: Int64? = nil, endDate: Int64? = nil) -> RequestBuilder<PageAggregateInvoiceReportResource> {
