...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 6.87258498695337,
  "sale_count" : 3,
  "sales_total" : 1.345883141991444,
  "customer_count" : 6
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.0751292090553397,
  "sale_count" : 5,
  "sales_total" : 5.730778251714277,
  "customer_count" : 3
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.073243943245025,
  "sale_count" : 1,
  "sales_total" : 6.825892881370458,
  "customer_count" : 3
}}]
