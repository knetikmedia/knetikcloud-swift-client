...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 3.3527466722373997,
  "sale_count" : 1,
  "sales_total" : 0.06269982596147305,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 3.128139058981798,
  "sale_count" : 8,
  "sales_total" : 5.163124577788974,
  "customer_count" : 4
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.5798571225584412,
  "sale_count" : 1,
  "sales_total" : 5.252352951186532,
  "customer_count" : 1
}}]
