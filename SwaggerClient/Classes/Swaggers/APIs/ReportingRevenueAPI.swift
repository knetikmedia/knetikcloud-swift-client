...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 5.238931714453975,
  "sale_count" : 0,
  "sales_total" : 7.487259429735276,
  "customer_count" : 1
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.172721600831064,
  "sale_count" : 5,
  "sales_total" : 4.438952903049287,
  "customer_count" : 5
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 8.316343639049778,
  "sale_count" : 2,
  "sales_total" : 7.308701218299465,
  "customer_count" : 3
}}]
