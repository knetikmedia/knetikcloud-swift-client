...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 4.747523674965431,
  "sale_count" : 1,
  "sales_total" : 1.0509036417804218,
  "customer_count" : 7
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.365562012910043,
  "sale_count" : 7,
  "sales_total" : 9.94566953621241,
  "customer_count" : 5
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.0816994350406546,
  "sale_count" : 6,
  "sales_total" : 0.11836104386125701,
  "customer_count" : 5
}}]
