...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 9.69912119461902,
  "sale_count" : 9,
  "sales_total" : 7.651958115052687,
  "customer_count" : 2
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.830615260020129,
  "sale_count" : 1,
  "sales_total" : 3.369198828035614,
  "customer_count" : 0
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.071367492233362,
  "sale_count" : 6,
  "sales_total" : 3.376740851784504,
  "customer_count" : 6
}}]
