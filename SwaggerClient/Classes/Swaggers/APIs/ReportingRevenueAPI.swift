...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 8.893903094915654,
  "sale_count" : 0,
  "sales_total" : 4.067142718807161,
  "customer_count" : 1
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.5103751269735,
  "sale_count" : 4,
  "sales_total" : 2.7334123034713596,
  "customer_count" : 6
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.278395032353411,
  "sale_count" : 3,
  "sales_total" : 7.675870447525195,
  "customer_count" : 0
}}]
