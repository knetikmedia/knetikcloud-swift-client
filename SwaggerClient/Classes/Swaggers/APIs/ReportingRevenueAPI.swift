...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 3.692752521441448,
  "sale_count" : 5,
  "sales_total" : 9.116440271005281,
  "customer_count" : 2
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 5.7797422524780115,
  "sale_count" : 0,
  "sales_total" : 2.572478814168208,
  "customer_count" : 2
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.865600957443579,
  "sale_count" : 7,
  "sales_total" : 2.8769650299101155,
  "customer_count" : 7
}}]
