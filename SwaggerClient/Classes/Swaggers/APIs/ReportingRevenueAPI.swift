...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 4.403167388709788,
  "sale_count" : 8,
  "sales_total" : 9.040396787698194,
  "customer_count" : 2
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.199211982718126,
  "sale_count" : 6,
  "sales_total" : 1.8346503025008498,
  "customer_count" : 8
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.050607068163841,
  "sale_count" : 0,
  "sales_total" : 3.025747042820588,
  "customer_count" : 3
}}]
