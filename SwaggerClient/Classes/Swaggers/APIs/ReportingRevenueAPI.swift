...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 5.561245317619928,
  "sale_count" : 3,
  "sales_total" : 7.976695120524781,
  "customer_count" : 5
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.116547507318737,
  "sale_count" : 0,
  "sales_total" : 0.15765852276084513,
  "customer_count" : 7
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.746154466909576,
  "sale_count" : 4,
  "sales_total" : 8.0429847369497,
  "customer_count" : 1
}}]
