...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 2.5141046075689353,
  "sale_count" : 2,
  "sales_total" : 6.57436284919698,
  "customer_count" : 1
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 3.6503254357585844,
  "sale_count" : 6,
  "sales_total" : 3.56522045531705,
  "customer_count" : 0
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 2.97540746154916,
  "sale_count" : 4,
  "sales_total" : 4.668484645962106,
  "customer_count" : 8
}}]
