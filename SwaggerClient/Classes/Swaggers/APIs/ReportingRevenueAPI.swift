...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 5.320425982344582,
  "sale_count" : 2,
  "sales_total" : 4.1393124132539345,
  "customer_count" : 1
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.65161151594924,
  "sale_count" : 2,
  "sales_total" : 7.4553313819768565,
  "customer_count" : 9
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 0.0763150018374048,
  "sale_count" : 5,
  "sales_total" : 3.105120598498128,
  "customer_count" : 3
}}]
