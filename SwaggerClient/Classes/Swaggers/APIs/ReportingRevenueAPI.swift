...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 2.326012147493789,
  "sale_count" : 5,
  "sales_total" : 7.110077878732105,
  "customer_count" : 4
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.550147691375384,
  "sale_count" : 9,
  "sales_total" : 9.745420218173798,
  "customer_count" : 9
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.88530776985708,
  "sale_count" : 3,
  "sales_total" : 5.260475690380375,
  "customer_count" : 6
}}]
