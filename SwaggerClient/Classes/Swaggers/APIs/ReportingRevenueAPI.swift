...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 8.030403334210524,
  "sale_count" : 1,
  "sales_total" : 9.296288973361165,
  "customer_count" : 7
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 4.51712212654898,
  "sale_count" : 9,
  "sales_total" : 6.874506856817678,
  "customer_count" : 2
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 7.492101379216217,
  "sale_count" : 8,
  "sales_total" : 4.430405192766646,
  "customer_count" : 1
}}]
