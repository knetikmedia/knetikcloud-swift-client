...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 2.2805574697177833,
  "sale_count" : 3,
  "sales_total" : 7.995315797087956,
  "customer_count" : 7
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 0.6324459346634603,
  "sale_count" : 0,
  "sales_total" : 4.498777320333063,
  "customer_count" : 7
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 1.6958015600093057,
  "sale_count" : 9,
  "sales_total" : 8.16211586184078,
  "customer_count" : 5
}}]
