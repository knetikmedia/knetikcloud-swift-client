...
public class ReportingRevenueAPI: APIBase {
  ...
  "sales_average" : 1.5934358246019065,
  "sale_count" : 1,
  "sales_total" : 3.0842875379836956,
  "customer_count" : 8
}}]
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 9.4795674240272,
  "sale_count" : 1,
  "sales_total" : 9.543560523127764,
  "customer_count" : 0
}}]
  ...
  "first" : true
    ...
    /**
     ...
     - OAuth:
       ...
       - name: OAuth2
     - examples: [{contentType=application/json, example={
  "sales_average" : 6.304664221288922,
  "sale_count" : 9,
  "sales_total" : 6.414525503026713,
  "customer_count" : 5
}}]
