...
public class ReportingSubscriptionsAPI: APIBase {
     ...
     */
    public class func listBillingReportsUsingGET(size size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceBillingReport?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func listBillingReportsUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceBillingReport> {
