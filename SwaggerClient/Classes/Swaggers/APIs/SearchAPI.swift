...
public class SearchAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func searchUsingPOST(type type: String, query: AnyObject? = nil, size: Int32? = nil, page: Int32? = nil, completion: ((data: PageResourceMapstringobject?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func searchUsingPOSTWithRequestBuilder(type type: String, query: AnyObject? = nil, size: Int32? = nil, page: Int32? = nil) -> RequestBuilder<PageResourceMapstringobject> {
        var path = "/search/index/{type}"
        path = path.stringByReplacingOccurrencesOfString("{type}", withString: "\(type)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
