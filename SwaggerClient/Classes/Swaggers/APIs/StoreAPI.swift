...
public class StoreAPI: APIBase {
     ...
     */
    public class func createItemTemplateUsingPOST(itemTemplateResource itemTemplateResource: ItemTemplateResource? = nil, completion: ((data: ItemTemplateResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func createItemTemplateUsingPOSTWithRequestBuilder(itemTemplateResource itemTemplateResource: ItemTemplateResource? = nil) -> RequestBuilder<ItemTemplateResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemTemplateUsingGET(id id: String, completion: ((data: ItemTemplateResource?, error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<ItemTemplateResource> 
     */
    public class func getItemTemplateUsingGETWithRequestBuilder(id id: String) -> RequestBuilder<ItemTemplateResource> {
        var path = "/store/items/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemTemplatesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageItemTemplateResource?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func getItemTemplatesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageItemTemplateResource> {
        let path = "/store/items/templates"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateItemTemplateUsingPUT(id id: String, itemTemplateResource: ItemTemplateResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateItemTemplateUsingPUTWithRequestBuilder(id id: String, itemTemplateResource: ItemTemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/store/items/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = itemTemplateResource?.encodeToJSON() as? [String:AnyObject]
