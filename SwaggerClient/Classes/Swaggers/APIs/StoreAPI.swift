...
public class StoreAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getItemTemplatesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceStoreItemTemplateResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getItemTemplatesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceStoreItemTemplateResource> {
        let path = "/store/items/templates"
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUsingGET2(limit limit: Int32? = nil, page: Int32? = nil, useCatalog: Bool? = nil, ignoreLocation: Bool? = nil, inStockOnly: Bool? = nil, completion: ((data: PageResourceStoreItem?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceStoreItem> 
     */
    public class func getUsingGET2WithRequestBuilder(limit limit: Int32? = nil, page: Int32? = nil, useCatalog: Bool? = nil, ignoreLocation: Bool? = nil, inStockOnly: Bool? = nil) -> RequestBuilder<PageResourceStoreItem> {
        let path = "/store"
        let URLString = SwaggerClientAPI.basePath + path
