...
public class StoreAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func createStoreItem(storeItem storeItem: StoreItem? = nil, completion: ((data: StoreItem?, error: ErrorType?) -> Void)) {
  ...
  "category" : "aeiou"
     ...
     */
    public class func createStoreItemWithRequestBuilder(storeItem storeItem: StoreItem? = nil) -> RequestBuilder<StoreItem> {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateItemTemplate(id id: String, itemTemplateResource: StoreItemTemplateResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateItemTemplateWithRequestBuilder(id id: String, itemTemplateResource: StoreItemTemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/store/items/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = itemTemplateResource?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateStoreItem(id id: Int32, storeItem: StoreItem? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateStoreItemWithRequestBuilder(id id: Int32, storeItem: StoreItem? = nil) -> RequestBuilder<Void> {
        var path = "/store/items/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = storeItem?.encodeToJSON() as? [String:AnyObject]
