...
public class StoreAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 3,
    "original_price" : 4.415932431263203,
    "description" : "aeiou",
    "stop_date" : 0,
    "published" : false,
    "inventory" : 6,
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 3,
      "original_price" : 7.721071956188177,
      "description" : "aeiou",
      "stop_date" : 5,
      "published" : false,
      "inventory" : 9,
  ...
  "skus" : [ {
    "sale_id" : 3,
    "original_price" : 6.423625528203164,
    "description" : "aeiou",
    "stop_date" : 5,
    "published" : false,
    "inventory" : 6,
  ...
  "category" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getStoreItems(filterNameSearch filterNameSearch: String? = nil, filterUniqueKey: String? = nil, filterPublished: Bool? = nil, filterDisplayable: Bool? = nil, filterStart: String? = nil, filterEnd: String? = nil, filterStartDate: String? = nil, filterStopDate: String? = nil, filterSku: String? = nil, filterPrice: String? = nil, filterTag: String? = nil, filterItemsByType: String? = nil, filterBundledSkus: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceStoreItem?, error: ErrorType?) -> Void)) {
  ...
  "content" : [ {
    ...
    "skus" : [ {
      "sale_id" : 6,
      "original_price" : 3.1645425628266666,
      "description" : "aeiou",
      "stop_date" : 6,
      "published" : false,
      "inventory" : 8,
  ...
  "skus" : [ {
    "sale_id" : 1,
    "original_price" : 3.544296476244061,
    "description" : "aeiou",
    "stop_date" : 5,
    "published" : false,
    "inventory" : 4,
