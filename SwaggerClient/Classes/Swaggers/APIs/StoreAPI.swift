...
public class StoreAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUsingGET2(storeListRequest storeListRequest: StoreListRequest? = nil, completion: ((data: PageResourceStoreItem?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceStoreItem> 
     */
    public class func getUsingGET2WithRequestBuilder(storeListRequest storeListRequest: StoreListRequest? = nil) -> RequestBuilder<PageResourceStoreItem> {
        let path = "/store"
        let URLString = SwaggerClientAPI.basePath + path
