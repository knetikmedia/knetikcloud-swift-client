...
public class StoreBundlesAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 6,
    "original_price" : 8.401575185243427,
    "description" : "aeiou",
    "stop_date" : 5,
    "published" : false,
    "inventory" : 8,
  ...
  "bundled_skus" : [ {
    "quantity" : 9,
    "price_override" : 9.94628502429565,
    "sku" : "aeiou"
  } ],
  ...
  "skus" : [ {
    "sale_id" : 1,
    "original_price" : 9.75016854659889,
    "description" : "aeiou",
    "stop_date" : 6,
    "published" : false,
    "inventory" : 5,
  ...
  "bundled_skus" : [ {
    "quantity" : 8,
    "price_override" : 7.504210441846077,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 2,
  ...
  "skus" : [ {
    "sale_id" : 9,
    "original_price" : 0.13767081288909688,
    "description" : "aeiou",
    "stop_date" : 1,
    "published" : false,
    "inventory" : 9,
  ...
  "bundled_skus" : [ {
    "quantity" : 0,
    "price_override" : 7.65490213359417,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 5,
