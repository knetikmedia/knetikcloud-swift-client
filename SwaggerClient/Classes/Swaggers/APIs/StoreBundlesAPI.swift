...
public class StoreBundlesAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 6,
    "original_price" : 6.272726738265524,
    "description" : "aeiou",
    "stop_date" : 8,
    "published" : false,
    "inventory" : 6,
  ...
  "bundled_skus" : [ {
    "quantity" : 7,
    "price_override" : 7.490061681912463,
    "sku" : "aeiou"
  } ],
  ...
  "skus" : [ {
    "sale_id" : 3,
    "original_price" : 5.2049020867662845,
    "description" : "aeiou",
    "stop_date" : 9,
    "published" : false,
    "inventory" : 1,
  ...
  "bundled_skus" : [ {
    "quantity" : 1,
    "price_override" : 3.783300674774531,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 0,
  ...
  "skus" : [ {
    "sale_id" : 2,
    "original_price" : 9.77191689505667,
    "description" : "aeiou",
    "stop_date" : 5,
    "published" : false,
    "inventory" : 5,
  ...
  "bundled_skus" : [ {
    "quantity" : 9,
    "price_override" : 9.82480836470765,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 1,
