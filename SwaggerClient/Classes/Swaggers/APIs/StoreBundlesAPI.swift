...
public class StoreBundlesAPI: APIBase {
  ...
  "skus" : [ {
    "sale_id" : 9,
    "original_price" : 4.669420222729758,
    "description" : "aeiou",
    "stop_date" : 8,
    "published" : false,
    "inventory" : 4,
  ...
  "bundled_skus" : [ {
    "quantity" : 6,
    "price_override" : 4.133998491228558,
    "sku" : "aeiou"
  } ],
  ...
  "skus" : [ {
    "sale_id" : 2,
    "original_price" : 3.8768247599757046,
    "description" : "aeiou",
    "stop_date" : 3,
    "published" : false,
    "inventory" : 6,
  ...
  "bundled_skus" : [ {
    "quantity" : 7,
    "price_override" : 8.01597035184198,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 2,
  ...
  "skus" : [ {
    "sale_id" : 9,
    "original_price" : 4.413367564889615,
    "description" : "aeiou",
    "stop_date" : 1,
    "published" : false,
    "inventory" : 2,
  ...
  "bundled_skus" : [ {
    "quantity" : 8,
    "price_override" : 7.412916803426649,
    "sku" : "aeiou"
  } ],
  "long_description" : "aeiou",
  "sort" : 7,
