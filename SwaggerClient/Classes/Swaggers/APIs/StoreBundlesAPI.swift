...
public class StoreBundlesAPI: APIBase {
     ...
     */
    public class func createBundleItem(bundleItem bundleItem: BundleItem? = nil, completion: ((data: BundleItem?, error: ErrorType?) -> Void)) {
  ...
  "category" : "aeiou"
     ...
     */
    public class func createBundleItemWithRequestBuilder(bundleItem bundleItem: BundleItem? = nil) -> RequestBuilder<BundleItem> {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateBundleItem(id id: Int32, bundleItem: BundleItem? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateBundleItemWithRequestBuilder(id id: Int32, bundleItem: BundleItem? = nil) -> RequestBuilder<Void> {
        var path = "/store/bundles/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = bundleItem?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateBundleTemplate(id id: String, bundleTemplateResource: ItemTemplateResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateBundleTemplateWithRequestBuilder(id id: String, bundleTemplateResource: ItemTemplateResource? = nil) -> RequestBuilder<Void> {
        var path = "/store/bundles/templates/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = bundleTemplateResource?.encodeToJSON() as? [String:AnyObject]
