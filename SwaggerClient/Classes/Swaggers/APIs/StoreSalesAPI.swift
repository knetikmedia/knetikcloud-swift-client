...
public class StoreSalesAPI: APIBase {
  ...
  "currency_code" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCatalogSalesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceCatalogSale?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getCatalogSalesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceCatalogSale> {
        let path = "/store/sales"
        let URLString = SwaggerClientAPI.basePath + path
