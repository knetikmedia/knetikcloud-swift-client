...
public class StoreShoppingCartsAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getCountries(id id: String, completion: ((data: SampleCountriesResponse?, error: ErrorType?) -> Void)) {
  ...
  "vendor_id1" : [ {
     ...
     */
    public class func getCountriesWithRequestBuilder(id id: String) -> RequestBuilder<SampleCountriesResponse> {
