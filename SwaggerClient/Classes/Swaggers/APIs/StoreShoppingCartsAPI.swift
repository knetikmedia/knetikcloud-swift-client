...
public class StoreShoppingCartsAPI: APIBase {
  ...
  "vendor_id1" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func searchCartsUsingGET(filterOwnerId filterOwnerId: Int32? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceCartSummary?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func searchCartsUsingGETWithRequestBuilder(filterOwnerId filterOwnerId: Int32? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceCartSummary> {
        let path = "/carts"
        let URLString = SwaggerClientAPI.basePath + path
