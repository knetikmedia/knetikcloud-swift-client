...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 7,
    "initial_fee" : 5.879851228414031,
    "late_payment_fee" : 2.0760578912013528,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 9.109162760679622,
    "min_cycles" : 5,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    ...
    "reactivation_fee" : 0.7634025814939882,
    "max_cycles" : 3
  } ],
  "store_start" : 8,
  "vendor_id" : 5,
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 3.9654629295269728,
    "late_payment_fee" : 1.5412953537894403,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.4727722688253742,
    "min_cycles" : 2,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 0,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 0.2143064112689841,
    "max_cycles" : 5
  } ],
  "store_start" : 9,
  "vendor_id" : 0,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 4,
      "initial_fee" : 7.305942351382717,
      "late_payment_fee" : 7.898533194765941,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 3.2429198570432494,
      "min_cycles" : 0,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 0,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 1.5863581754163936,
      "max_cycles" : 6
    } ],
    "store_start" : 5,
    "vendor_id" : 3,
