...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 5.014743100236402,
    "late_payment_fee" : 8.842258233326133,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 8.079393249177194,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 9,
    ...
    "reactivation_fee" : 8.845142786836623,
    "max_cycles" : 1
  } ],
  "store_start" : 9,
  "vendor_id" : 3,
  ...
  "plans" : [ {
    "end_date" : 7,
    "initial_fee" : 3.0211466173063526,
    "late_payment_fee" : 6.440925844603909,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.648816936430393,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 3,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.697157335502577,
    "max_cycles" : 2
  } ],
  "store_start" : 5,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 2,
      "initial_fee" : 9.77488036685473,
      "late_payment_fee" : 1.7166194691563197,
      "billing_cycle_length" : 2,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 6.960023941460962,
      "min_cycles" : 5,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 8,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 9.297287007253658,
      "max_cycles" : 3
    } ],
    "store_start" : 3,
    "vendor_id" : 9,
