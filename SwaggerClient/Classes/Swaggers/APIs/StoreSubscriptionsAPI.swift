...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 8.501020098301112,
    "late_payment_fee" : 2.090423294405034,
    "billing_cycle_length" : 8,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.664588362288997,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    ...
    "reactivation_fee" : 9.943673966559746,
    "max_cycles" : 3
  } ],
  "store_start" : 4,
  "vendor_id" : 6,
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 0.9010774853570103,
    "late_payment_fee" : 1.8147732911754133,
    "billing_cycle_length" : 9,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.855575287951412,
    "min_cycles" : 5,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 7.33692035818313,
    "max_cycles" : 0
  } ],
  "store_start" : 3,
  "vendor_id" : 2,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 0.14518329242535932,
      "late_payment_fee" : 4.188706233758714,
      "billing_cycle_length" : 7,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 4.08612504159278,
      "min_cycles" : 3,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 6,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 6.963370919490379,
      "max_cycles" : 6
    } ],
    "store_start" : 1,
    "vendor_id" : 9,
