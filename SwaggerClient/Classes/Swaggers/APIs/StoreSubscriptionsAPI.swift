...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 8,
    "initial_fee" : 9.104282259506634,
    "late_payment_fee" : 2.878526213927486,
    "billing_cycle_length" : 4,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 8.142968421812254,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    ...
    "reactivation_fee" : 4.4120556431464895,
    "max_cycles" : 0
  } ],
  "store_start" : 7,
  "vendor_id" : 7,
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 6.917457541893613,
    "late_payment_fee" : 6.486528677760645,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.402855582466951,
    "min_cycles" : 1,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 7.569730801617826,
    "max_cycles" : 2
  } ],
  "store_start" : 5,
  "vendor_id" : 8,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 8.885839200027245,
      "late_payment_fee" : 6.15681681860152,
      "billing_cycle_length" : 9,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 9.12555019060758,
      "min_cycles" : 3,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 2,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 2.9857836544747784,
      "max_cycles" : 6
    } ],
    "store_start" : 2,
    "vendor_id" : 0,
