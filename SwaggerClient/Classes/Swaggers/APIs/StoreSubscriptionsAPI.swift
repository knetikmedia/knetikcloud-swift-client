...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 2.013369039188139,
    "late_payment_fee" : 0.7226847786349511,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 9.404167037341622,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 7,
    ...
    "reactivation_fee" : 0.3360489506722808,
    "max_cycles" : 0
  } ],
  "store_start" : 7,
  "vendor_id" : 9,
  ...
  "plans" : [ {
    "end_date" : 7,
    "initial_fee" : 5.355567278785479,
    "late_payment_fee" : 8.320464702886586,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 4.2958391890067835,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.1989423271093,
    "max_cycles" : 0
  } ],
  "store_start" : 9,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 4,
      "initial_fee" : 0.8996984549831777,
      "late_payment_fee" : 2.567160353725705,
      "billing_cycle_length" : 1,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 6.874207999437598,
      "min_cycles" : 8,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 1,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 3.77498312715372,
      "max_cycles" : 5
    } ],
    "store_start" : 4,
    "vendor_id" : 9,
