...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 5.466171489475414,
    "late_payment_fee" : 4.238011403853953,
    "billing_cycle_length" : 4,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.268953876639029,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    ...
    "reactivation_fee" : 0.1572803486032892,
    "max_cycles" : 0
  } ],
  "store_start" : 4,
  "vendor_id" : 1,
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 7.650714027895546,
    "late_payment_fee" : 2.8726285897317085,
    "billing_cycle_length" : 5,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 2.7125244318796904,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 7.356832878376616,
    "max_cycles" : 4
  } ],
  "store_start" : 5,
  "vendor_id" : 8,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 2.1514799538118545,
      "late_payment_fee" : 6.641398342260853,
      "billing_cycle_length" : 4,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 3.337809970318115,
      "min_cycles" : 0,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 7,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 5.685080881003549,
      "max_cycles" : 9
    } ],
    "store_start" : 7,
    "vendor_id" : 4,
