...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 2,
    "initial_fee" : 0.701531756439312,
    "late_payment_fee" : 4.9386221872308536,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.952484233124594,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 9,
    ...
    "reactivation_fee" : 9.930422826381827,
    "max_cycles" : 4
  } ],
  "store_start" : 4,
  "vendor_id" : 6,
  ...
  "plans" : [ {
    "end_date" : 4,
    "initial_fee" : 0.6311361190200815,
    "late_payment_fee" : 7.264239399778346,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.0663559714282673,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.841114919903383,
    "max_cycles" : 9
  } ],
  "store_start" : 7,
  "vendor_id" : 8,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 1,
      "initial_fee" : 2.836617823231289,
      "late_payment_fee" : 5.834099537684937,
      "billing_cycle_length" : 1,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 8.325302333358707,
      "min_cycles" : 4,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 5,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 3.9335738817406805,
      "max_cycles" : 7
    } ],
    "store_start" : 4,
    "vendor_id" : 5,
