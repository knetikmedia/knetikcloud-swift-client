...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 8.871933646171392,
    "late_payment_fee" : 8.732009807425648,
    "billing_cycle_length" : 9,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.002955551654065,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    ...
    "reactivation_fee" : 4.581808638418002,
    "max_cycles" : 4
  } ],
  "store_start" : 2,
  "vendor_id" : 9,
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 1.0619782105778086,
    "late_payment_fee" : 9.103483605171864,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 6.308802239236362,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 2.8557827217578846,
    "max_cycles" : 6
  } ],
  "store_start" : 5,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 9.131678998561549,
      "late_payment_fee" : 5.21653725325549,
      "billing_cycle_length" : 1,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 8.801432719957095,
      "min_cycles" : 1,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 9,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 6.712498346039433,
      "max_cycles" : 3
    } ],
    "store_start" : 0,
    "vendor_id" : 3,
