...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 0.21014627650865703,
    "late_payment_fee" : 2.6037372541964765,
    "billing_cycle_length" : 5,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.7751097719035513,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 0,
    ...
    "reactivation_fee" : 6.47685792136703,
    "max_cycles" : 7
  } ],
  "store_start" : 4,
  "vendor_id" : 7,
  ...
  "plans" : [ {
    "end_date" : 8,
    "initial_fee" : 1.0305059292126117,
    "late_payment_fee" : 4.136095433757893,
    "billing_cycle_length" : 1,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.6667494827722817,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 7,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 9.738213238865221,
    "max_cycles" : 8
  } ],
  "store_start" : 6,
  "vendor_id" : 4,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 1,
      "initial_fee" : 3.6645833498507163,
      "late_payment_fee" : 7.522386584692748,
      "billing_cycle_length" : 1,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 8.10274592517265,
      "min_cycles" : 4,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 6,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 9.328061806560507,
      "max_cycles" : 4
    } ],
    "store_start" : 2,
    "vendor_id" : 2,
