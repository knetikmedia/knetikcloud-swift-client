...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 8,
    "initial_fee" : 4.664009735380516,
    "late_payment_fee" : 2.2964542781520434,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.947907581951317,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    ...
    "reactivation_fee" : 8.135807491389679,
    "max_cycles" : 4
  } ],
  "store_start" : 0,
  "vendor_id" : 4,
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 6.392061334996154,
    "late_payment_fee" : 3.9556757157433955,
    "billing_cycle_length" : 4,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.2776282414165718,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.60942308450017,
    "max_cycles" : 2
  } ],
  "store_start" : 3,
  "vendor_id" : 6,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 1.9713731602687468,
      "late_payment_fee" : 8.086637333427433,
      "billing_cycle_length" : 1,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 0.9990262531578875,
      "min_cycles" : 7,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 1,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 7.366794355885295,
      "max_cycles" : 4
    } ],
    "store_start" : 9,
    "vendor_id" : 3,
