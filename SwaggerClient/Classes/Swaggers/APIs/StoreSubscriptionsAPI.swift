...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 6,
    "initial_fee" : 6.325422418059321,
    "late_payment_fee" : 2.273687105928157,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.174061679759528,
    "min_cycles" : 6,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 0,
    ...
    "reactivation_fee" : 1.621351482538228,
    "max_cycles" : 4
  } ],
  "store_start" : 2,
  "vendor_id" : 2,
  ...
  "plans" : [ {
    "end_date" : 2,
    "initial_fee" : 2.842499064789302,
    "late_payment_fee" : 0.9412535746031869,
    "billing_cycle_length" : 9,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 1.3534752221550395,
    "min_cycles" : 8,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 1,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 7.567058007061283,
    "max_cycles" : 1
  } ],
  "store_start" : 7,
  "vendor_id" : 3,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 0.8308804602216213,
      "late_payment_fee" : 3.0689210867572703,
      "billing_cycle_length" : 2,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 1.6807929998751026,
      "min_cycles" : 4,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 2,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 9.526063027159125,
      "max_cycles" : 0
    } ],
    "store_start" : 5,
    "vendor_id" : 4,
