...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 1.9226359296605966,
    "late_payment_fee" : 7.691664151211896,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.556953174980757,
    "min_cycles" : 5,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 0,
    ...
    "reactivation_fee" : 3.7890720542074185,
    "max_cycles" : 2
  } ],
  "store_start" : 1,
  "vendor_id" : 2,
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 5.4712439238784025,
    "late_payment_fee" : 4.378703286941354,
    "billing_cycle_length" : 5,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 2.571135005338859,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 6,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 0.4582153404845757,
    "max_cycles" : 5
  } ],
  "store_start" : 5,
  "vendor_id" : 3,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 2,
      "initial_fee" : 2.660922446009657,
      "late_payment_fee" : 5.825706924047255,
      "billing_cycle_length" : 2,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 1.8192527846032125,
      "min_cycles" : 3,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 8,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 1.5796364090324133,
      "max_cycles" : 2
    } ],
    "store_start" : 4,
    "vendor_id" : 8,
