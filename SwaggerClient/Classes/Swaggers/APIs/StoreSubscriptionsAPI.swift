...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 9,
    "initial_fee" : 3.1995697801924736,
    "late_payment_fee" : 1.4827524629782751,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.279888352484473,
    "min_cycles" : 3,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 8,
    ...
    "reactivation_fee" : 2.331955213880663,
    "max_cycles" : 7
  } ],
  "store_start" : 4,
  "vendor_id" : 4,
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 7.934843721422503,
    "late_payment_fee" : 2.720946379391912,
    "billing_cycle_length" : 6,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 9.701694627580265,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 2,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 0.021925972815853845,
    "max_cycles" : 3
  } ],
  "store_start" : 8,
  "vendor_id" : 7,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 7.9105210774859644,
      "late_payment_fee" : 1.972893678725537,
      "billing_cycle_length" : 2,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 2.4199012198109604,
      "min_cycles" : 8,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 7,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 1.3566392327407528,
      "max_cycles" : 7
    } ],
    "store_start" : 1,
    "vendor_id" : 6,
