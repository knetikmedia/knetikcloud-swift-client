...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 0,
    "initial_fee" : 2.6775603719187835,
    "late_payment_fee" : 0.3184205149099817,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.9094527054244796,
    "min_cycles" : 7,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    ...
    "reactivation_fee" : 3.61904678126535,
    "max_cycles" : 7
  } ],
  "store_start" : 6,
  "vendor_id" : 5,
  ...
  "plans" : [ {
    "end_date" : 1,
    "initial_fee" : 0.06460811517916665,
    "late_payment_fee" : 2.4659066699957997,
    "billing_cycle_length" : 3,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 2.3138177791421297,
    "min_cycles" : 2,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 4,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.078040801577511,
    "max_cycles" : 5
  } ],
  "store_start" : 7,
  "vendor_id" : 1,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 8,
      "initial_fee" : 8.221341337514009,
      "late_payment_fee" : 7.421918412383879,
      "billing_cycle_length" : 5,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 9.308908958308805,
      "min_cycles" : 3,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 6,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 3.5996731127885306,
      "max_cycles" : 3
    } ],
    "store_start" : 7,
    "vendor_id" : 0,
