...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 1.1054634297957244,
    "late_payment_fee" : 9.655663993723362,
    "billing_cycle_length" : 7,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.980940079055905,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    ...
    "reactivation_fee" : 8.580596241456128,
    "max_cycles" : 6
  } ],
  "store_start" : 8,
  "vendor_id" : 5,
  ...
  "plans" : [ {
    "end_date" : 5,
    "initial_fee" : 9.067874650393136,
    "late_payment_fee" : 9.544703977012867,
    "billing_cycle_length" : 8,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 3.5423639279282493,
    "min_cycles" : 0,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 2.3469481579366844,
    "max_cycles" : 5
  } ],
  "store_start" : 7,
  "vendor_id" : 7,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 6,
      "initial_fee" : 1.3841542468058898,
      "late_payment_fee" : 9.793537152139736,
      "billing_cycle_length" : 1,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 8.637642546282368,
      "min_cycles" : 9,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 5,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 6.3896488917546135,
      "max_cycles" : 0
    } ],
    "store_start" : 1,
    "vendor_id" : 3,
