...
public class StoreSubscriptionsAPI: APIBase {
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 9.573657630269745,
    "late_payment_fee" : 5.83854999471407,
    "billing_cycle_length" : 2,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 7.421748105466676,
    "min_cycles" : 4,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 5,
    ...
    "reactivation_fee" : 6.860158579563471,
    "max_cycles" : 4
  } ],
  "store_start" : 2,
  "vendor_id" : 1,
  ...
  "plans" : [ {
    "end_date" : 3,
    "initial_fee" : 3.248801297202233,
    "late_payment_fee" : 6.349896645056119,
    "billing_cycle_length" : 0,
    "reactivation_sku" : "aeiou",
    "currency_code" : "aeiou",
    "recurring_fee" : 5.566349428342088,
    "min_cycles" : 9,
    "recurring_sku" : "aeiou",
    "max_bill_attempts" : 1,
    "additional_properties" : {
    ...
    "name" : "aeiou",
    "billing_cycle_unit" : "millisecond",
    "reactivation_fee" : 4.3316637561575675,
    "max_cycles" : 9
  } ],
  "store_start" : 2,
  "vendor_id" : 8,
  ...
  "content" : [ {
    ...
    "plans" : [ {
      "end_date" : 7,
      "initial_fee" : 5.153310814032582,
      "late_payment_fee" : 3.1162295463484546,
      "billing_cycle_length" : 7,
      "reactivation_sku" : "aeiou",
      "currency_code" : "aeiou",
      "recurring_fee" : 7.672890345293179,
      "min_cycles" : 8,
      "recurring_sku" : "aeiou",
      "max_bill_attempts" : 2,
      "additional_properties" : {
      ...
      "name" : "aeiou",
      "billing_cycle_unit" : "millisecond",
      "reactivation_fee" : 3.11446136249651,
      "max_cycles" : 5
    } ],
    "store_start" : 0,
    "vendor_id" : 2,
