...
public class TaxesAPI: APIBase {
     ...
     */
    public class func createCountryTax(taxResource taxResource: CountryTaxResource? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func createCountryTaxWithRequestBuilder(taxResource taxResource: CountryTaxResource? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func createStateTax(countryCodeIso3 countryCodeIso3: String, taxResource: StateTaxResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func createStateTaxWithRequestBuilder(countryCodeIso3 countryCodeIso3: String, taxResource: StateTaxResource? = nil) -> RequestBuilder<Void> {
  ...
  "country_iso3" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateCountryTax(countryCodeIso3 countryCodeIso3: String, taxResource: CountryTaxResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateCountryTaxWithRequestBuilder(countryCodeIso3 countryCodeIso3: String, taxResource: CountryTaxResource? = nil) -> RequestBuilder<Void> {
        var path = "/tax/countries/{country_code_iso3}"
        path = path.stringByReplacingOccurrencesOfString("{country_code_iso3}", withString: "\(countryCodeIso3)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = taxResource?.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateStateTax(countryCodeIso3 countryCodeIso3: String, stateCode: String, taxResource: StateTaxResource? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateStateTaxWithRequestBuilder(countryCodeIso3 countryCodeIso3: String, stateCode: String, taxResource: StateTaxResource? = nil) -> RequestBuilder<Void> {
        var path = "/tax/countries/{country_code_iso3}/states/{stateCode}"
        path = path.stringByReplacingOccurrencesOfString("{country_code_iso3}", withString: "\(countryCodeIso3)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{state_code}", withString: "\(stateCode)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
