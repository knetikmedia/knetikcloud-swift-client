...
public class TaxesAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getAllTaxesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceStateTaxResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getAllTaxesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceStateTaxResource> {
        let path = "/tax/states"
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "country_iso3" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTaxesUsingGET(size size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceCountryTaxResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getTaxesUsingGETWithRequestBuilder(size size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceCountryTaxResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTaxesUsingGET1(countryCodeIso3 countryCodeIso3: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceStateTaxResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceStateTaxResource> 
     */
    public class func getTaxesUsingGET1WithRequestBuilder(countryCodeIso3 countryCodeIso3: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceStateTaxResource> {
        var path = "/tax/countries/{country_code_iso3}/states"
        path = path.stringByReplacingOccurrencesOfString("{country_code_iso3}", withString: "\(countryCodeIso3)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
