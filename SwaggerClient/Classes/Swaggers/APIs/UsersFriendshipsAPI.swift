...
public class UsersFriendshipsAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getFriendsUsingGET(userId userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceSimpleUserResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getFriendsUsingGETWithRequestBuilder(userId userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceSimpleUserResource> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getInvitesUsingGET(userId userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceSimpleUserResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     - returns: RequestBuilder<PageResourceSimpleUserResource> 
     */
    public class func getInvitesUsingGETWithRequestBuilder(userId userId: String, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceSimpleUserResource> {
