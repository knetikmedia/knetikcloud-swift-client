...
public class UsersGroupsAPI: APIBase {
  ...
  "properties" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateGroups(filterName filterName: String? = nil, filterUniqueName: String? = nil, filterParent: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil, completion: ((data: PageResourceGroupResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func updateGroupsWithRequestBuilder(filterName filterName: String? = nil, filterUniqueName: String? = nil, filterParent: String? = nil, size: Int32? = nil, page: Int32? = nil, order: String? = nil) -> RequestBuilder<PageResourceGroupResource> {
        let path = "/users/groups"
        let URLString = SwaggerClientAPI.basePath + path
