...
public class UsersInventoryAPI: APIBase {
  ...
  "status" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserInventory1(id id: Int32, inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterMinDate: Int64? = nil, filterMaxDate: Int64? = nil, completion: ((data: PageResourceUserInventoryResource?, error: ErrorType?) -> Void)) {
  ...
  "first" : true
     ...
     */
    public class func getUserInventory1WithRequestBuilder(id id: Int32, inactive: Bool? = nil, size: Int32? = nil, page: Int32? = nil, filterItemName: String? = nil, filterMinDate: Int64? = nil, filterMaxDate: Int64? = nil) -> RequestBuilder<PageResourceUserInventoryResource> {
        var path = "/users/{id}/inventory"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getUserInventoryLog1(userId userId: Int32, id: Int32, timestamp: Int64? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getUserInventoryLog1WithRequestBuilder(userId userId: Int32, id: Int32, timestamp: Int64? = nil) -> RequestBuilder<Void> {
